...
class Income_tax2 extends BaseController
{
    ...
    public function returns_ddf()
    {
        ...
        $ddfArr = $this->Mact_option->where('act_option_map_tbl.status', 1)
                        ...
                        ->where('act_option_map_tbl.due_date_type', 1)
                        ->orderBy('act_option_map_tbl.sortBy', "ASC")
                        ->findAll();
    
        $this->data['ddfArr']=$ddfArr;
        
        return view('firm_panel/compliance/income_tax/returns_ddf', $this->data);
    }
    
    public function returns($ddfId)
    {
        ...
        $ftr_clientgrp = (!empty(get_cookie("inc_tax_rtn_clientgrp_cookie"))) ? get_cookie("inc_tax_rtn_clientgrp_cookie") : "";
        $ftr_client = (!empty(get_cookie("inc_tax_rtn_client_cookie"))) ? get_cookie("inc_tax_rtn_client_cookie") : "";
        $ftr_junior = (!empty(get_cookie("inc_tax_rtn_junior_cookie"))) ? get_cookie("inc_tax_rtn_junior_cookie") : "";
        $ftr_staff = (!empty(get_cookie("inc_tax_rtn_staff_cookie"))) ? get_cookie("inc_tax_rtn_staff_cookie") : "";
        $ftr_e_verify = (!empty(get_cookie("inc_tax_rtn_e_verify_cookie"))) ? get_cookie("inc_tax_rtn_e_verify_cookie") : "";
        $ftr_set_by = (!empty(get_cookie("inc_tax_rtn_set_by_cookie"))) ? get_cookie("inc_tax_rtn_set_by_cookie") : "";
        $ftr_billing = (!empty(get_cookie("inc_tax_rtn_billing_cookie"))) ? get_cookie("inc_tax_rtn_billing_cookie") : "";
        $ftr_receipt = (!empty(get_cookie("inc_tax_rtn_receipt_cookie"))) ? get_cookie("inc_tax_rtn_receipt_cookie") : "";
        ...
        return view('firm_panel/compliance/income_tax/returns', $this->data);
    }
    
    public function returns_filed($ddfId)
    {
        ini_set('memory_limit', '-1');
        ...
        return view('firm_panel/compliance/income_tax/returns_filed', $this->data);
    }
    ...
    public function search_returns()
    {
        ...
        if(!empty($ftr_clientgrp))
            $this->setMyCookie("inc_tax_rtn_clientgrp_cookie", $ftr_clientgrp, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_rtn_clientgrp_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_client))
            $this->setMyCookie("inc_tax_rtn_client_cookie", $ftr_client, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_rtn_client_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_junior))
            $this->setMyCookie("inc_tax_rtn_junior_cookie", $ftr_junior, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_rtn_junior_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_staff))
            $this->setMyCookie("inc_tax_rtn_staff_cookie", $ftr_staff, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_rtn_staff_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_e_verify))
            $this->setMyCookie("inc_tax_rtn_e_verify_cookie", $ftr_e_verify, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_rtn_e_verify_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_set_by))
            $this->setMyCookie("inc_tax_rtn_set_by_cookie", $ftr_set_by, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_rtn_set_by_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_billing))
            $this->setMyCookie("inc_tax_rtn_billing_cookie", $ftr_billing, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_rtn_billing_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_receipt))
            $this->setMyCookie("inc_tax_rtn_receipt_cookie", $ftr_receipt, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_rtn_receipt_cookie", "", $cookieExpirationTime);
            
        if($ftr_type==1)
            return redirect()->to(base_url("it-returns/".$ddfId));
        elseif($ftr_type==2)
            return redirect()->to(base_url("it-returns-filed/".$ddfId));
    }
    
    public function reset_returns()
    {
        $cookieExpirationTime = time()+3600;
    ...
    public function tax_audits_ddf()
    {
        $uri = service('uri');
        $this->data['uri1']=$uri1=$uri->getSegment(1);
        ...
        $ddfArr = $this->Mact_option->where('act_option_map_tbl.status', 1)
                        ->where('act_option_map_tbl.fk_act_id', 1)
                        ->where('act_option_map_tbl.option_type', 1)
                        ->where('act_option_map_tbl.due_date_type', 3)
                        ->orderBy('act_option_map_tbl.sortBy', "ASC")
                        ->findAll();
    
        $this->data['ddfArr']=$ddfArr;
        
        return view('firm_panel/compliance/income_tax/tax_audits_ddf', $this->data);
    }
    
    public function tax_audits($ddfId)
    {
        ini_set('memory_limit', '-1');
        ...
        $ftr_clientgrp = (!empty(get_cookie("inc_tax_adt_clientgrp_cookie"))) ? get_cookie("inc_tax_adt_clientgrp_cookie") : "";
        $ftr_client = (!empty(get_cookie("inc_tax_adt_client_cookie"))) ? get_cookie("inc_tax_adt_client_cookie") : "";
        $ftr_junior = (!empty(get_cookie("inc_tax_adt_junior_cookie"))) ? get_cookie("inc_tax_adt_junior_cookie") : "";
        $ftr_staff = (!empty(get_cookie("inc_tax_adt_staff_cookie"))) ? get_cookie("inc_tax_adt_staff_cookie") : "";
        $ftr_e_verify = (!empty(get_cookie("inc_tax_adt_e_verify_cookie"))) ? get_cookie("inc_tax_adt_e_verify_cookie") : "";
        $ftr_set_by = (!empty(get_cookie("inc_tax_adt_set_by_cookie"))) ? get_cookie("inc_tax_adt_set_by_cookie") : "";
        $ftr_billing = (!empty(get_cookie("inc_tax_adt_billing_cookie"))) ? get_cookie("inc_tax_adt_billing_cookie") : "";
        $ftr_receipt = (!empty(get_cookie("inc_tax_adt_receipt_cookie"))) ? get_cookie("inc_tax_adt_receipt_cookie") : "";
        ...
        return view('firm_panel/compliance/income_tax/tax_audits', $this->data);
    }
    
    public function tax_audits_filed($ddfId)
    {
        ini_set('memory_limit', '-1');
        ...
        return view('firm_panel/compliance/income_tax/tax_audits_filed', $this->data);
    }
    
    public function search_tax_audits()
    {
        $ftr_type=$this->request->getPost("ftr_type");
        $ddfId=$this->request->getPost("ddfId");
        $ftr_clientgrp=$this->request->getPost("ftr_clientgrp");
        ...
        if(!empty($ftr_clientgrp))
            $this->setMyCookie("inc_tax_adt_clientgrp_cookie", $ftr_clientgrp, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_adt_clientgrp_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_client))
            $this->setMyCookie("inc_tax_adt_client_cookie", $ftr_client, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_adt_client_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_junior))
            $this->setMyCookie("inc_tax_adt_junior_cookie", $ftr_junior, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_adt_junior_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_staff))
            $this->setMyCookie("inc_tax_adt_staff_cookie", $ftr_staff, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_adt_staff_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_e_verify))
            $this->setMyCookie("inc_tax_adt_e_verify_cookie", $ftr_e_verify, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_adt_e_verify_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_set_by))
            $this->setMyCookie("inc_tax_adt_set_by_cookie", $ftr_set_by, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_adt_set_by_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_billing))
            $this->setMyCookie("inc_tax_adt_billing_cookie", $ftr_billing, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_adt_billing_cookie", "", $cookieExpirationTime);
            
        if(!empty($ftr_receipt))
            $this->setMyCookie("inc_tax_adt_receipt_cookie", $ftr_receipt, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_adt_receipt_cookie", "", $cookieExpirationTime);
            
        if($ftr_type==1)
            return redirect()->to(base_url("it-tax-audits/".$ddfId));
        elseif($ftr_type==2)
            return redirect()->to(base_url("it-tax-audits-filed/".$ddfId));
    }
    
    public function reset_tax_audits()
    {
        $cookieExpirationTime = time()+3600;
    ...
    public function inc_tax_certificates()
    {
        ini_set('memory_limit', '-1');
        ...
        $pageTitle="Income Tax - Certificates";
        $this->data['pageTitle']=$pageTitle;
        ...
        $selected_mth_tab = (!empty(get_cookie("inc_tax_cert_selected_mth_tab_cookie"))) ? get_cookie("inc_tax_cert_selected_mth_tab_cookie") : "";
        $ftr_clientgrp = (!empty(get_cookie("inc_tax_cert_clientgrp_cookie"))) ? get_cookie("inc_tax_cert_clientgrp_cookie") : "";
        $ftr_client = (!empty(get_cookie("inc_tax_cert_client_cookie"))) ? get_cookie("inc_tax_cert_client_cookie") : "";
        $ftr_costcenter = (!empty(get_cookie("inc_tax_cert_costcenter_cookie"))) ? get_cookie("inc_tax_cert_costcenter_cookie") : "";
        $ftr_junior = (!empty(get_cookie("inc_tax_cert_junior_cookie"))) ? get_cookie("inc_tax_cert_junior_cookie") : "";
        $ftr_staff = (!empty(get_cookie("inc_tax_cert_staff_cookie"))) ? get_cookie("inc_tax_cert_staff_cookie") : "";
        $ftr_ddf = (!empty(get_cookie("inc_tax_cert_ddf_cookie"))) ? get_cookie("inc_tax_cert_ddf_cookie") : "";
        $ftr_period = (!empty(get_cookie("inc_tax_cert_period_cookie"))) ? get_cookie("inc_tax_cert_period_cookie") : "";
        $ftr_ddm = (!empty(get_cookie("inc_tax_cert_ddm_cookie"))) ? get_cookie("inc_tax_cert_ddm_cookie") : "";
        $ftr_e_verify = (!empty(get_cookie("inc_tax_cert_e_verify_cookie"))) ? get_cookie("inc_tax_cert_e_verify_cookie") : "";
        $ftr_set_by = (!empty(get_cookie("inc_tax_cert_set_by_cookie"))) ? get_cookie("inc_tax_cert_set_by_cookie") : "";
        $ftr_billing = (!empty(get_cookie("inc_tax_cert_billing_cookie"))) ? get_cookie("inc_tax_cert_billing_cookie") : "";
        $ftr_receipt = (!empty(get_cookie("inc_tax_cert_receipt_cookie"))) ? get_cookie("inc_tax_cert_receipt_cookie") : "";
        ...
        $workCondtnArr['due_date_for_tbl.due_date_type']=4;
        ...
        $ddfCondtnArr['act_option_map_tbl.due_date_type']=4;
        ...
        return view('firm_panel/compliance/income_tax/inc_tax_certificates', $this->data);
    }
    
    public function inc_tax_certificates_filed()
    {
        ini_set('memory_limit', '-1');
        ...
        return view('firm_panel/compliance/income_tax/inc_tax_certificates_filed', $this->data);
    }
    ...
    public function search_inc_tax_certificates()
    {
        $ftr_type=$this->request->getPost('ftr_type');
        ...
        if(!empty($selected_mth_tab))
            $this->setMyCookie("inc_tax_cert_selected_mth_tab_cookie", $selected_mth_tab, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_selected_mth_tab_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_clientgrp))
            $this->setMyCookie("inc_tax_cert_clientgrp_cookie", $ftr_clientgrp, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_clientgrp_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_client))
            $this->setMyCookie("inc_tax_cert_client_cookie", $ftr_client, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_client_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_costcenter))
            $this->setMyCookie("inc_tax_cert_costcenter_cookie", $ftr_costcenter, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_costcenter_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_junior))
            $this->setMyCookie("inc_tax_cert_junior_cookie", $ftr_junior, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_junior_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_staff))
            $this->setMyCookie("inc_tax_cert_staff_cookie", $ftr_staff, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_staff_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_ddf))
            $this->setMyCookie("inc_tax_cert_ddf_cookie", $ftr_ddf, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_ddf_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_period))
            $this->setMyCookie("inc_tax_cert_period_cookie", $ftr_period, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_period_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_ddm))
            $this->setMyCookie("inc_tax_cert_ddm_cookie", $ftr_ddm, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_ddm_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_e_verify))
            $this->setMyCookie("inc_tax_cert_e_verify_cookie", $ftr_e_verify, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_e_verify_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_set_by))
            $this->setMyCookie("inc_tax_cert_set_by_cookie", $ftr_set_by, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_set_by_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_billing))
            $this->setMyCookie("inc_tax_cert_billing_cookie", $ftr_billing, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_billing_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_receipt))
            $this->setMyCookie("inc_tax_cert_receipt_cookie", $ftr_receipt, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_cert_receipt_cookie", '', $cookieExpirationTime);
            
        if($ftr_type==1)
            return redirect()->to(base_url('inc-tax-certificates'));
        elseif($ftr_type==2)
            return redirect()->to(base_url('inc-tax-certificates-filed'));
    }
    
    public function reset_inc_tax_certificates()
    {
        $cookieExpirationTime = time()+3600;
    ...
    public function inc_tax_statements()
    {
        ini_set('memory_limit', '-1');
        ...
        $selected_mth_tab = (!empty(get_cookie("inc_tax_stmnt_selected_mth_tab_cookie"))) ? get_cookie("inc_tax_stmnt_selected_mth_tab_cookie") : "";
        $ftr_clientgrp = (!empty(get_cookie("inc_tax_stmnt_clientgrp_cookie"))) ? get_cookie("inc_tax_stmnt_clientgrp_cookie") : "";
        $ftr_client = (!empty(get_cookie("inc_tax_stmnt_client_cookie"))) ? get_cookie("inc_tax_stmnt_client_cookie") : "";
        $ftr_costcenter = (!empty(get_cookie("inc_tax_stmnt_costcenter_cookie"))) ? get_cookie("inc_tax_stmnt_costcenter_cookie") : "";
        $ftr_junior = (!empty(get_cookie("inc_tax_stmnt_junior_cookie"))) ? get_cookie("inc_tax_stmnt_junior_cookie") : "";
        $ftr_staff = (!empty(get_cookie("inc_tax_stmnt_staff_cookie"))) ? get_cookie("inc_tax_stmnt_staff_cookie") : "";
        $ftr_ddf = (!empty(get_cookie("inc_tax_stmnt_ddf_cookie"))) ? get_cookie("inc_tax_stmnt_ddf_cookie") : "";
        $ftr_period = (!empty(get_cookie("inc_tax_stmnt_period_cookie"))) ? get_cookie("inc_tax_stmnt_period_cookie") : "";
        $ftr_ddm = (!empty(get_cookie("inc_tax_stmnt_ddm_cookie"))) ? get_cookie("inc_tax_stmnt_ddm_cookie") : "";
        $ftr_e_verify = (!empty(get_cookie("inc_tax_stmnt_e_verify_cookie"))) ? get_cookie("inc_tax_stmnt_e_verify_cookie") : "";
        $ftr_set_by = (!empty(get_cookie("inc_tax_stmnt_set_by_cookie"))) ? get_cookie("inc_tax_stmnt_set_by_cookie") : "";
        $ftr_billing = (!empty(get_cookie("inc_tax_stmnt_billing_cookie"))) ? get_cookie("inc_tax_stmnt_billing_cookie") : "";
        $ftr_receipt = (!empty(get_cookie("inc_tax_stmnt_receipt_cookie"))) ? get_cookie("inc_tax_stmnt_receipt_cookie") : "";
        ...
        $workCondtnArr['due_date_for_tbl.status']=1;
        $workCondtnArr['act_tbl.act_id']=1;
        $workCondtnArr['due_date_for_tbl.due_date_type']=5;
        ...
        $ddfCondtnArr['act_option_map_tbl.fk_act_id']="1";
        $ddfCondtnArr['act_option_map_tbl.option_type']="1";
        $ddfCondtnArr['act_option_map_tbl.due_date_type']=5;
        $ddfOrderByArr['act_option_map_tbl.act_option_name']="ASC";
        ...
        return view('firm_panel/compliance/income_tax/inc_tax_statements', $this->data);
    }
    
    public function inc_tax_statements_filed()
    {
        ini_set('memory_limit', '-1');
        ...
        return view('firm_panel/compliance/income_tax/inc_tax_statements_filed', $this->data);
    }
    
    public function search_inc_tax_statements()
    {
        $ftr_type=$this->request->getPost('ftr_type');
        $selected_mth_tab=$this->request->getPost('selected_mth_tab');
        $ftr_clientgrp=$this->request->getPost('ftr_clientgrp');
        ...
        if(!empty($selected_mth_tab))
            $this->setMyCookie("inc_tax_stmnt_selected_mth_tab_cookie", $selected_mth_tab, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_selected_mth_tab_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_clientgrp))
            $this->setMyCookie("inc_tax_stmnt_clientgrp_cookie", $ftr_clientgrp, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_clientgrp_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_client))
            $this->setMyCookie("inc_tax_stmnt_client_cookie", $ftr_client, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_client_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_costcenter))
            $this->setMyCookie("inc_tax_stmnt_costcenter_cookie", $ftr_costcenter, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_costcenter_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_junior))
            $this->setMyCookie("inc_tax_stmnt_junior_cookie", $ftr_junior, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_junior_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_staff))
            $this->setMyCookie("inc_tax_stmnt_staff_cookie", $ftr_staff, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_staff_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_ddf))
            $this->setMyCookie("inc_tax_stmnt_ddf_cookie", $ftr_ddf, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_ddf_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_period))
            $this->setMyCookie("inc_tax_stmnt_period_cookie", $ftr_period, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_period_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_ddm))
            $this->setMyCookie("inc_tax_stmnt_ddm_cookie", $ftr_ddm, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_ddm_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_e_verify))
            $this->setMyCookie("inc_tax_stmnt_e_verify_cookie", $ftr_e_verify, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_e_verify_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_set_by))
            $this->setMyCookie("inc_tax_stmnt_set_by_cookie", $ftr_set_by, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_set_by_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_billing))
            $this->setMyCookie("inc_tax_stmnt_billing_cookie", $ftr_billing, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_billing_cookie", '', $cookieExpirationTime);
            
        if(!empty($ftr_receipt))
            $this->setMyCookie("inc_tax_stmnt_receipt_cookie", $ftr_receipt, $cookieExpirationTime);
        else
            $this->setMyCookie("inc_tax_stmnt_receipt_cookie", '', $cookieExpirationTime);
            
        if($ftr_type==1)
            return redirect()->to(base_url('inc-tax-statements'));
        elseif($ftr_type==2)
            return redirect()->to(base_url('inc-tax-statements-filed'));
    }
    
    public function reset_inc_tax_statements()
    {
        $cookieExpirationTime = time()+3600;
