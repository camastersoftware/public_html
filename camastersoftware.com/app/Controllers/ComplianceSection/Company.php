...
class Company extends BaseController
{
    public function __construct()
    {
        ...
        // Work Form Route
        $this->workFormRoute[1]="company-work-form/"; // Returns
        $this->workFormRoute[2]=""; // Payments
        $this->workFormRoute[3]="company-audit-work-form/"; // Audits
        ...
        $this->secPrefixUrl="company"; // Section Prefix URL
        $this->cookiekPref="company"; // Cookie Prefix
    }
    ...
    public function menus()
    {
        ...
        return view('firm_panel/compliance/companies/menus', $this->data);
    }
    ...
    public function due_date_for($ddType)
    {
        ...
        $pageTitle="Companies Act - ".$due_date_type;
        $this->data['pageTitle']=$pageTitle;
        ...
        return view('firm_panel/compliance/companies/due_date_for', $this->data);
    }
    ...
    public function pending($ddfId)
    {
        ...
        return view('firm_panel/compliance/companies/pending', $this->data);
    }
    ...
    public function filed($ddfId)
    {
        ...
        $pageTitle="Companies Act - Returns - Filed";
        $this->data['pageTitle']=$pageTitle;
        ...
        return view('firm_panel/compliance/companies/filed', $this->data);
    }
