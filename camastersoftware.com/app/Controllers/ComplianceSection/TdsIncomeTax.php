...
class TdsIncomeTax extends BaseController
{
    ...
    public function returns()
    {
        ...
        $pageTitle="TDS - Income Tax - Returns";
        ...
        if(!empty($ftr_ddf))
            ...
            $workWhereInArray['due_date_for_tbl.act_option_map_id']=TDS_INC_RET_DDF_ARRAY;
        ...
        $workCondtnArr['act_tbl.act_id']=3;
        ...
        $ddfCondtnArr['act_option_map_tbl.fk_act_id']="3";
        $ddfCondtnArr['act_option_map_tbl.option_type']="1";
        $ddfOrderByArr['act_option_map_tbl.act_option_name']="ASC";
        
        $ddfWhereInArray['act_option_map_tbl.act_option_map_id']=TDS_INC_RET_DDF_ARRAY;
        ...
        return view('firm_panel/compliance/tds_income_tax/returns', $this->data);
    }
    ...
    public function payments()
    {
        ...
        $pageTitle="TDS - Income Tax - Payments";
        $this->data['pageTitle']=$pageTitle;
        ...
        if(!empty($ftr_ddf))
            ...
            $workWhereInArray['due_date_for_tbl.act_option_map_id']=TDS_INC_PMT_DDF_ARRAY;
        ...
        $ddfWhereInArray['act_option_map_tbl.act_option_map_id']=TDS_INC_PMT_DDF_ARRAY;
        ...
        return view('firm_panel/compliance/tds_income_tax/payments', $this->data);
    }
    ...
    public function certificates()
    {
        ...
        $pageTitle="TDS - Income Tax - Certificates";
        $this->data['pageTitle']=$pageTitle;
        ...
        return view('firm_panel/compliance/tds_income_tax/certificates', $this->data);
    }
}