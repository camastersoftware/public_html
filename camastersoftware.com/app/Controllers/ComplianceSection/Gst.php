...
class Gst extends BaseController
{
    public function __construct()
    {
        ...
        // Work Form Route
        $this->workFormRoute[1]="gst-work-form/"; // Returns
        ...
        $this->secPrefixUrl="gst"; // Section Prefix URL
        $this->cookiekPref="gst"; // Cookie Prefix
    }
    ...
    public function menus()
    {
        ...
        return view('firm_panel/compliance/gst/menus', $this->data);
    }
    ...
    public function due_date_for($ddType)
    {
        ...
        return view('firm_panel/compliance/gst/'.$viewPage, $this->data);
    }
    ...
    public function pending($ddfId)
    {
        ...
        return view('firm_panel/compliance/gst/pending', $this->data);
    }
    ...
    public function filed($ddfId)
    {
        ...
        return view('firm_panel/compliance/gst/filed', $this->data);
    }
