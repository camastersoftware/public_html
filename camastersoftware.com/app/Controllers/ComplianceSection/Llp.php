...
class Llp extends BaseController
{
    public function __construct()
    {
        ...
        // Work Form Route
        $this->workFormRoute[1]="llp-work-form/"; // Returns
        $this->workFormRoute[2]=""; // Payments
        $this->workFormRoute[3]="llp-audit-work-form/"; // Audits
        ...
        $this->secPrefixUrl="llp"; // Section Prefix URL
        $this->cookiekPref="llp"; // Cookie Prefix
    }
    ...
    public function menus()
    {
        ...
        return view('firm_panel/compliance/llp/menus', $this->data);
    }
    ...
    public function due_date_for($ddType)
    {
        ...
        return view('firm_panel/compliance/llp/due_date_for', $this->data);
    }
    ...
    public function pending($ddfId)
    {
        ...
        return view('firm_panel/compliance/llp/pending', $this->data);
    }
    ...
    public function filed($ddfId)
    {
        ...
        return view('firm_panel/compliance/llp/filed', $this->data);
    }
    ...
    public function returns()
    {
        ...
        $workCondtnArr['due_date_for_tbl.status']=1;
        $workCondtnArr['act_tbl.act_id']=6;
        ...
        $ddfCondtnArr['act_option_map_tbl.fk_act_id']="6";
        $ddfCondtnArr['act_option_map_tbl.option_type']="1";
        $ddfOrderByArr['act_option_map_tbl.act_option_name']="ASC";
        
        $ddfWhereInArray['act_option_map_tbl.act_option_map_id']=LLP_RET_DDF_ARRAY;
        ...
        return view('firm_panel/compliance/llp/returns', $this->data);
    }
    ...
    public function work_form($workId)
	{
        ...
        return view('firm_panel/compliance/llp/work_form', $this->data);
    }
    ...
    public function delete_ack_file()
	{
        ...
        if(!empty($workArr))
        {
            ...
            {
                $uploadPath=FCPATH.'uploads/ca_firm_'.$this->sessCaFirmId.'/compliance/llp/'.$ackUploadFile;
        ...
        {
            $this->session->setFlashdata('errorMsg', "Something went wrong!!, LLP acknowlegement file not deleted :(");
        }
        ...
        else
        {
            ...
            $insertLogArr['section']=$this->section;
            $insertLogArr['message']="LLP acknowlegement file deleted";
            $insertLogArr['ip']=$this->IPAddress;
            $insertLogArr['createdBy']=$this->adminId;
            $insertLogArr['createdDatetime']=$this->currTimeStamp;
            ...
            $this->session->setFlashdata('successMsg', "LLP acknowlegement file has been deleted successfully :)");
            
            return true;
        }
	}
    
    public function work_form_old()
	{
        $uri = service('uri');
        $this->data['uri1']=$uri1=$uri->getSegment(1);
    ...
    public function audits()
    {
        ...
        if(!empty($ftr_ddf))
            ...
            $workWhereInArray['due_date_for_tbl.act_option_map_id']=LLP_ADT_DDF_ARRAY;
        ...
        $ddfWhereInArray['act_option_map_tbl.act_option_map_id']=LLP_ADT_DDF_ARRAY;
        ...
        return view('firm_panel/compliance/llp/audits', $this->data);
    }
    ...
    public function audit_work_form()
	{
        ...
        return view('firm_panel/compliance/llp/audit_work_form', $this->data);
    }
    
    public function audit_work_form_old()
	{
        $uri = service('uri');
        $this->data['uri1']=$uri1=$uri->getSegment(1);
    ...
    public function register_section()
    {
        ...
        return view('firm_panel/compliance/llp/register_section', $this->data);
    }
    ...
    public function return_filed_register()
    {
        ...
        $pageTitle="LLP - Returns Register";
        $this->data['pageTitle']=$pageTitle;
        ...
        $ddIDArr = array_merge(LLP_RET_DDF_ARRAY, LLP_ADT_DDF_ARRAY);
        ...
        return view('firm_panel/compliance/llp/return_filed_register', $this->data);
    }
    ...
    public function assessee_ledger()
	{
        ...
        return view('firm_panel/compliance/llp/assessee_ledger', $this->data);
	}
	...
	public function assessee_ledger_client()
	{
        ...
        $workWhereInArray['due_date_for_tbl.act_option_map_id']=$ddIDArr;
        ...
        return view('firm_panel/compliance/llp/assessee_ledger_client', $this->data);
	}
	
	public function mis_menu()
    {
        $uri = service('uri');
        $this->data['uri1']=$uri1=$uri->getSegment(1);
    ...
    public function mis_returns_summary()
	{
        ...
        $taxWhereInArray['due_date_for_tbl.act_option_map_id']=LLP_RET_DDF_ARRAY;
        ...
        return view('firm_panel/compliance/llp/mis_returns_summary', $this->data);
    }
    
    public function mis_staff_summary()
    {
        $uri = service('uri');
        $this->data['uri1']=$uri1=$uri->getSegment(1);
        ...
        return view('firm_panel/compliance/llp/mis_staff_summary', $this->data);
    }
    
    public function deed_details()
	{
        $uri = service('uri');
        $this->data['uri1']=$uri1=$uri->getSegment(1);
        ...
        return view('firm_panel/compliance/llp/deed_details', $this->data);
    }
	...
	public function deeds($clientId)
	{
        ...
        $clientCondtn['client_tbl.clientBussOrganisationType']=2;
        
        $clientDataArr = $this->Mclient->where($clientCondtn)->first();
        
        $this->data['clientDataArr']=$clientDataArr;
        
        $deedCondtnArr['firm_deed_tbl.actType']=2;
        ...
        return view('firm_panel/compliance/llp/deeds', $this->data);
    }
	...
	public function add_deed($clientId)
	{
        ...
        $pageTitle="LLP Agreement - Add Deed";
        $this->data['pageTitle']=$pageTitle;
        ...
        $ptFirmDeedCondtn['firm_deed_tbl.status']=1;
        $ptFirmDeedCondtn['firm_deed_tbl.actType']=2;
        ...
        return view('firm_panel/compliance/llp/add_deed', $this->data);
    }
    ...
    public function create_deed()
	{
	    ...
	    if($this->db->transStatus() === FALSE)
        {
            ...
            $this->session->setFlashdata('errorMsg', "Something went wrong!!, LLP Deed Agreement not added :(");
        }
        else
        {
            $this->db->transCommit();
            ...
            $insertLogArr['section']=$this->section;
            $insertLogArr['message']="LLP Deed Agreement added";
            $insertLogArr['ip']=$this->IPAddress;
            $insertLogArr['createdBy']=$this->adminId;
            $insertLogArr['createdDatetime']=$this->currTimeStamp;
            ...
            $this->session->setFlashdata('successMsg', "LLP Deed Agreement has been added successfully :)");
        }
        
        return redirect()->to('llp-firm-deeds/'.$fkClientId);
	}
	...
	public function edit_deed($clientId, $firmDeedId)
	{
        ...
        $pageTitle="LLP Agreement - Edit Deed";
        $this->data['pageTitle']=$pageTitle;
        ...
        return view('firm_panel/compliance/llp/edit_deed', $this->data);
    }
    ...
    public function update_deed()
	{
	    ...
	    if($this->db->transStatus() === FALSE)
        {
            ...
            $this->session->setFlashdata('errorMsg', "Something went wrong!!, LLP Deed Agreement not updated :(");
        }
        else
        {
            $this->db->transCommit();
            ...
            $insertLogArr['section']=$this->section;
            $insertLogArr['message']="LLP Deed Agreement updated";
            $insertLogArr['ip']=$this->IPAddress;
            $insertLogArr['createdBy']=$this->adminId;
            $insertLogArr['createdDatetime']=$this->currTimeStamp;
            ...
            $this->session->setFlashdata('successMsg', "LLP Deed Agreement has been updated successfully :)");
        }
	...
	public function view_deed($clientId, $firmDeedId)
	{
        ...
        $pageTitle="LLP Agreement - View Deed";
        $this->data['pageTitle']=$pageTitle;
        ...
        return view('firm_panel/compliance/llp/view_deed', $this->data);
    }
	...
	public function delete_deed()
	{
	    ...
	    if($this->MfirmDeed->save($insertArr))
	    {
	        ...
	        $this->session->setFlashdata('successMsg', "LLP Deed Agreement has been deleted successfully :)");
	    }
	    else
	    {
	        $this->session->setFlashdata('errorMsg', "LLP Deed Agreement has not deleted :(");
	    }
	}
}