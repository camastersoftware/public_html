...
class Referncer extends BaseController
{
	...
	public function index()
	{
        ...
        return view('super_admin/referncer/home', $this->data);
	}
	...
	public function add()
	{
	    ...
	    if($this->Mreferncer->save($insertArr))
	    {
	    ...
	    return redirect()->route('superadmin/referncer');
	}
	...
	public function updateData()
	{
	    ...
	    $this->Mreferncer->save($insertArr);
	...
	public function refGroups()
	{
        ...
        return view('super_admin/referncer/refGroups', $this->data);
	}
	...
	public function addGroup()
	{
	    ...
	    if($this->Mrefgroup->save($insertArr))
	    {
	        $insertLogArr['section']=$this->section;
	    ...
	    return redirect()->route('superadmin/refGroups');
	}
	...
	public function refSubGroups()
	{
        ...
        $refSubGrpArr = $this->Mrefsubgroup->join('referencer_groups', 'referencer_groups.refGrpId=referencer_sub_groups.fkRefGrpId', 'left')
        ...
        return view('super_admin/referncer/refSubGroups', $this->data);
	}
	...
	public function addSubGroup()
	{
	    ...
	    if($this->Mrefsubgroup->save($insertArr))
	    {
	        $insertLogArr['section']=$this->section;
	    ...
	    return redirect()->route('superadmin/refSubGroups');
	}
	...
	public function editSubGroup()
	{
	    ...
	    $this->Mrefsubgroup->save($insertArr);
