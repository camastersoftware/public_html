...
class Announcement extends BaseController
{
	...
	public function index()
	{
        ...
        return view('firm_panel/announcement/list', $this->data);
	}
	...
	public function superadmin()
	{
        ...
        $pageTitle="Announcements by CAMaster";
        $this->data['pageTitle']=$pageTitle;
        ...
        return view('firm_panel/announcement/superadmin_list', $this->data);
	}
	...
	public function add()
	{
	    ...
	    if($this->Mannouncement->save($insertArr))
	    {
	...
	public function updateData()
	{
	    ...
	    $this->Mannouncement->save($insertArr);
