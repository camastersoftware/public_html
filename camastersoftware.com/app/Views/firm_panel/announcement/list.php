...
<style>
                ...
                <div class="box mt-40">
                    <div class="box-header with-border flexbox text-center">
                        ...
                        <div class="text-right flex-grow">
                            <a href="<?php echo base_url('superadmin-announcements'); ?>">
                                <button class="btn btn-sm btn-success" data-toggle="tooltip" data-original-title="CAMaster Announcements">
                                    CAMaster
                                </button>
                            </a>
                            &nbsp;&nbsp;
        ...
        <div id="updateModal<?php echo $e_row['ancId']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <form action="<?php echo base_url('editAnnouncement'); ?>" method="POST" enctype="multipart/form-data" >
    ...
    <div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="<?php echo base_url('addAnnouncement'); ?>" method="POST" enctype="multipart/form-data" >
                    <div class="modal-header">
        ...
        $('.stopAnc').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/stopAnnouncement';
                    $.post(postingUrl, 
                    {
                        ancId: ancId
                    },
        ...
        $('.deactivateAnc').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/deactivateAnc';
                    $.post(postingUrl, 
                    {
                        ancId: ancId
                    },
        ...
        $('.activateAnc').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/activateAnc';
                    $.post(postingUrl, 
                    {
                        ancId: ancId
                    },
        ...
        $('.deleteAnc').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/deleteAnnouncement';
                    $.post(postingUrl, 
                    {
                        ancId: ancId
                    },
