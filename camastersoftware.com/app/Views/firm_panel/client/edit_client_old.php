                ...
                <div class="box-body box_body_bg wizard-content"> 
                    <form action="javascript:void(0);" class="tab-wizard wizard-circle edit_client_form" enctype="multipart/form-data">
                        ...
                        <section>
                            ...
                            <div class="row business_div">
                                    ...
                                    <div class="row ind_div">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <?php 
                                                    $clientDob="";
                                                    if(!empty($clientData['clientDob']) && $clientData['clientDob']!="1970-01-01")
                                        ...
                                        <!--<div class="col-md-8">-->
                                        <!--    <div class="form-group">-->
                                        <!--        <label for="edit_clientPassport">Passport:</label>-->
                                        <!--        <input type="text" class="form-control" name="edit_clientPassport" id="edit_clientPassport" placeholder="Enter Passport Number" value="<?php //echo $clientData['clientPassport']; ?>"> -->
                                        <!--    </div>-->
                                        <!--</div>-->
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientBussOrganisationEmp">Organisation Name :</label>
                                                <input type="text" class="form-control" name="edit_clientBussOrganisationEmp" id="edit_clientBussOrganisationEmp" placeholder="Enter Organisation Name (Employed With)" value="<?php echo $clientData['clientBussOrganisationEmp']; ?>"> 
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <?php 
                                                    ...
                                                    if(!empty($clientData['clientBussIncorporationDate']) && $clientData['clientBussIncorporationDate']!="1970-01-01")
                                                        $clientBussIncorporationDate=date("Y-m-d", strtotime($clientData['clientBussIncorporationDate']));
                                                ?>
                                                <label for="edit_clientBussIncorporationDate">Date of Incorporation/Registration :</label>
                                    ...
                                    <div class="row photo_div">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <label class="file">
                                                    <input type="file" name="edit_clientProfileImg" id="edit_clientProfileImg">
                                                    <input type="hidden" name="edit_clientProfileOldImg" value="<?php echo $clientData['clientProfileImg']; ?>" >
                                                </label>
                                            </div>
                                        </div>	
                                    </div>
                                ...
                                <div class="col-md-6 contact_div">
                                    ...
                                    <!--    <div class="col-md-8">-->
                                    <!--        <div class="form-group">-->
                                    <!--            <label for="edit_clientBussWhatsApp">Mobile (WhatsApp) :</label>-->
                                    <!--            <input type="tel" class="form-control" name="edit_clientBussWhatsApp" id="edit_clientBussWhatsApp" placeholder="Enter Mobile (WhatsApp)" value="<?php //echo $clientData['clientBussWhatsApp']; ?>"> -->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--</div> -->
                            ...
                            <div class="row" id="client_grp_row">
                                <div class="col-md-3">
                                    ...
                                    <button type="button" name="Add" class="waves-effect waves-light btn btn-submit text-right" data-toggle="modal" data-target="#edit_addClientGrpModal">Add Client Group</button>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="edit_clientCostCenter">Cost Center:</label>
                                        <input type="text" class="form-control" name="edit_clientCostCenter" id="edit_clientCostCenter" value="<?php echo $clientData['clientCostCenter']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="edit_clientCategory">Category:</label>
                                        <input type="text" class="form-control" name="edit_clientCategory" id="edit_clientCategory" value="<?php echo $clientData['clientCategory']; ?>"> 
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-10">
                                <div class="col-md-12 text-right">
                                    <button type="button" class="waves-effect waves-light btn btn-submit text-right" data-toggle="modal" data-target="#addClientPartnerModal">Add Partner</button>
                                </div>
                                <div class="col-md-12 mt-20">
                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable no-footer">
                                        ...
                                        <tbody class="row-hover" id="client_partner_tbl">
                                            <?php if(!empty($clientPartnerList)): ?>
                                                <?php foreach($clientPartnerList AS $k_cl_pt=>$e_cl_pt): ?>
                                                    <tr class="row-3 cli_pt_row_<?php echo $k_cl_pt.$e_cl_pt['client_partner_id']; ?>" style="background-color:#f6fbff;">
                                                        <td class="column-1 text-left">
                                                            <?php echo $e_cl_pt['client_partner_name']; ?>
                                                            <input type="hidden" name="edit_client_partner_name[]" value="<?php echo $e_cl_pt['client_partner_name']; ?>" />
                                                        </td>
                                                        <td class="column-1">
                                                            <?php echo $e_cl_pt['client_partner_text']; ?>
                                                            <input type="hidden" name="edit_client_partner_text[]" value="<?php echo $e_cl_pt['client_partner_text']; ?>" />
                                                        </td>
                                                        <td class="column-1">
                                                            <?php echo $e_cl_pt['client_partner_pan']; ?>
                                                            <input type="hidden" name="edit_client_partner_pan[]" value="<?php echo $e_cl_pt['client_partner_pan']; ?>" />
                                                        </td>
                                                        <td class="column-1">
                                                            <?php echo $e_cl_pt['client_partner_aadhar']; ?>
                                                            <input type="hidden" name="edit_client_partner_aadhar[]" value="<?php echo $e_cl_pt['client_partner_aadhar']; ?>" />
                                                        </td>
                                                        <td class="column-1">
                                                            <?php 
                                                                $client_partner_appt_date="";
                                                                if(!empty($e_cl_pt['client_partner_appt_date']) && $e_cl_pt['client_partner_appt_date']!="0000-00-00" && $e_cl_pt['client_partner_appt_date']!="1970-01-01")
                                                                    $client_partner_appt_date=date('d-m-Y', strtotime($e_cl_pt['client_partner_appt_date'])); 
                                                            ?>
                                                            <?php echo $client_partner_appt_date; ?>
                                                            <input type="hidden" name="edit_client_partner_appt_date[]" value="<?php echo $client_partner_appt_date; ?>" />
                                                        </td>
                                                        <td class="column-1">
                                                            <?php 
                                                                $client_partner_date="";
                                                                if(!empty($e_cl_pt['client_partner_date']) && $e_cl_pt['client_partner_date']!="0000-00-00" && $e_cl_pt['client_partner_date']!="1970-01-01")
                                                                    $client_partner_date=date('d-m-Y', strtotime($e_cl_pt['client_partner_date'])); 
                                                            ?>
                                                            <?php echo $client_partner_date; ?>
                                                            <input type="hidden" name="edit_client_partner_date[]" value="<?php echo $client_partner_date; ?>" />
                                                        </td>
                                                        <td class="column-1">
                                                            <input type="hidden" name="edit_client_partner_id[]" value="<?php echo $e_cl_pt['client_partner_id']; ?>" />
                                                            <div class="btn-group">
                                                                <button type="button" class="waves-effect waves-light btn btn-info btn-sm btnPrimClr dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Action</button>
                                                                <div class="dropdown-menu" style="will-change: transform;">
                                                                    <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal" data-target="#editClientPartnerModal<?php echo $k_cl_pt.$e_cl_pt['client_partner_id']; ?>"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                                                    <a class="dropdown-item del_cli_pt" href="javascript:void(0);" data-toggle="tooltip" data-original-title="Delete"  data-id="<?php echo $k_cl_pt.$e_cl_pt['client_partner_id']; ?>" data-client_partner_id="<?php echo $e_cl_pt['client_partner_id']; ?>"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                                                </div>
                                                            </div>
                                                            <!--<button type="button" name="button" class="btn btn-danger text-left del_cli_pt" data-id="<?php //echo $k_cl_pt.$e_cl_pt['client_partner_id']; ?>" data-client_partner_id="<?php //echo $e_cl_pt['client_partner_id']; ?>">Delete</button>-->
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <td class="column-1 text-center" id="cli_pt_empty" colspan="7">No records</td>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <section>
                            <div class="row">
                                ...
                                <div class="col-md-6 cont_personal">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientMobile1">Mobile 1 :</label>
                                                <input type="tel" class="form-control" name="edit_clientMobile1" id="edit_clientMobile1" placeholder="Enter Mobile 1" value="<?php //echo $clientData['clientMobile1']; ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientMobile2">Mobile 2 :</label>
                                                <input type="tel" class="form-control" name="edit_clientMobile2" id="edit_clientMobile2" placeholder="Enter Mobile 2" value="<?php //echo $clientData['clientMobile2']; ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientWhatsApp">Mobile (WhatsApp):</label>
                                                <input type="tel" class="form-control" name="edit_clientWhatsApp" id="edit_clientWhatsApp" placeholder="Mobile (WhatsApp)" value="<?php //echo $clientData['clientWhatsApp']; ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientResidencePhone">Residence Phone :</label>
                                                <input type="tel" class="form-control" name="edit_clientResidencePhone" id="edit_clientResidencePhone" placeholder="Enter Residence phone" value="<?php //echo $clientData['clientResidencePhone']; ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientOfficePhone1">Office Phone 1 :</label>
                                                <input type="tel" class="form-control" name="edit_clientOfficePhone1" id="edit_clientOfficePhone1" placeholder="Enter Office Phone 1" value="<?php //echo $clientData['clientOfficePhone1']; ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_sclientOfficePhone2">Office Phone 2 :</label>
                                                <input type="tel" class="form-control" name="edit_clientOfficePhone2" id="edit_clientOfficePhone2" placeholder="Enter Office Phone 2" value="<?php //echo $clientData['clientOfficePhone2']; ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientFactoryPhone">Factory Phone :</label>
                                                <input type="tel" class="form-control" name="edit_clientFactoryPhone" id="edit_clientFactoryPhone" placeholder="Enter Factory Phone" value="<?php //echo $clientData['clientFactoryPhone']; ?>"> 
                                            </div>
                                        </div> 
                                    </div>  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientEmail1">Email 1 :</label>
                                                <input type="email" class="form-control" name="edit_clientEmail1" id="edit_clientEmail1" placeholder="Enter Email 1" value="<?php //echo $clientData['clientEmail1']; ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="edit_clientEmail2">Email 2 :</label>
                                                <input type="email" class="form-control" name="edit_clientEmail2" id="edit_clientEmail2" placeholder="Enter Email 2" value="<?php //echo $clientData['clientEmail2']; ?>"> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="edit_clientGroup">Client Group:</label>
                                        <select class="custom-select form-control" name="edit_clientGroupInd" id="edit_clientGroupInd">
                                            <option value="">Select Client Group</option>
                                            <?php //if(!empty($groupList)): ?>
                                                <?php //foreach($groupList AS $e_grp): ?>
                                                    <option value="<?php //echo $e_grp['client_group_id']; ?>" <?php //if($clientData['clientGroup']==$e_grp['client_group_id']): ?>selected<?php //endif; ?> ><?php //echo $e_grp['client_group']; ?></option>
                        ...
                        <section>
                            <div class="row">
                                <!--
                                <div class="col-md-12 edit_register_div">
                                    <div class="row">
                                        <div class="col-md-4 offset-md-4">
                                            <label for="edit_clientRegDocument" class="edit_register_label font-weight-bold" style="font-size:17px;">N/A</label>
                                            <input type="text" class="form-control" name="edit_clientRegDocument" id="edit_clientRegDocument" value="<?php //echo $clientData['clientRegDocument']; ?>">
                                        </div>
                                    </div>
                                    <div class="row justify-content-center mt-20">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="edit_clientRegDocumentIssueDate" id="edit_clientRegDocumentIssueDate" value="<?php //echo date("Y-m-d", strtotime($clientData['clientRegDocumentIssueDate'])); ?>"> 
                                            </div>
                                        </div>
                                        <div class="col-md-1"></div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="edit_clientRegDocumentEffectiveDate" id="edit_clientRegDocumentEffectiveDate" value="<?php //echo date("Y-m-d", strtotime($clientData['clientRegDocumentEffectiveDate'])); ?>"> 
                                            </div>
                                        </div>
                                        <div class="col-md-1"></div>
                                        <div class="col-md-3">
                                ...
                                <div class="col-md-12 edit_register_div">
                                    <div class="row doc_row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="edit_clientRegDocument" class="edit_register_label font-weight-bold" style="font-size:17px;">N/A</label>
                                                <input type="text" class="form-control" name="edit_clientRegDocument" id="edit_clientRegDocument" placeholder="" value="<?php echo $clientData['clientRegDocument']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-1"></div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="row doc_row" data-id="<?php echo $cli_doc_id; ?>">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="edit_client_document_number[]" id="edit_docName<?php echo $cli_doc_id; ?>" placeholder="Enter <?php echo $e_doc['client_document_name']; ?>" value="<?php echo $client_document_number; ?>"> 
                                                </div>
                                            </div>
                                            <div class="col-md-1"></div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <?php
                                                        ...
                                                        {
                                                            if($clientDocDataArr[$cli_doc_id]['client_document_issue_date']!="0000-00-00")
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <?php
                                                        ...
                                                        {
                                                            if($clientDocDataArr[$cli_doc_id]['client_document_effective_date']!="0000-00-00")
                                                    ...
                                                    <input type="date" class="form-control" name="edit_client_document_effective_date[]" id="edit_docEffectiveDate<?php echo $cli_doc_id; ?>" value="<?php echo $client_document_effective_date; ?>" value="<?php echo $client_document_effective_date; ?>"> 
                                                </div>
                                            </div>
                                            <div class="col-md-1"></div>
                                            <div class="col-md-2">
                                            ...
                                            <?php if(!empty($actList)): ?>
                                                <?php foreach($actList AS $e_act): ?>
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="checkbox" name='edit_actId[]' id="edit_actId<?php echo $e_act['act_id']; ?>" class="filled-in edit_acts_checkbox" value="<?php echo $e_act['act_id']; ?>" data-act_name="<?php echo $e_act['act_short_name']; ?>" <?php if(in_array($e_act['act_id'], $workActArr)): ?>checked<?php endif; ?> <?php if(in_array($e_act['act_id'], $workActArr)): ?>disabled<?php endif; ?> />
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="demo-checkbox">
                                        <div class="row mt-20 text-center edit_selected_acts_div">
                                            <div class="col-md-12">
                                                    ...
                                                    <?php foreach($actsListArr AS $k_row=>$e_row): ?>
                                                        <tr class="row-3 row_<?php echo $k_act_id.$k_row.$e_row['due_date_id']; ?>" style="background-color:#f6fbff;">
                                                            ...
                                                            <td class="column-8 text-center" style="width: 5% !important;" nowrap>
                                                                ...
                                                                <button type="button" class="waves-effect waves-light btn btn-sm btn-primary mb-5" data-toggle="modal" data-target="#modal_view<?php echo $k_act_id.$k_row; ?>">
                                                                    Note
                                                                </button>
...
<?php if(!empty($clientPartnerList)): ?>
    <?php foreach($clientPartnerList AS $k_cl_pt=>$e_cl_pt): ?>
    <div id="editClientPartnerModal<?php echo $k_cl_pt.$e_cl_pt['client_partner_id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo base_url('edit_partner'); ?>" method="POST" id="edit_client_partner_form">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Edit Client Partner</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>Partner Name<small class="text-danger">*</small></label>
                                    <input type="text" class="form-control" name="client_partner_name" placeholder="Enter Partner Name" value="<?php echo $e_cl_pt['client_partner_name']; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>DIN<small class="text-danger">*</small></label>
                                    <input type="text" class="form-control" name="client_partner_text" placeholder="Enter DIN" value="<?php echo $e_cl_pt['client_partner_text']; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>PAN<small class="text-danger">*</small></label>
                                    <input type="text" class="form-control" name="client_partner_pan" placeholder="Enter PAN" value="<?php echo $e_cl_pt['client_partner_pan']; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>Aadhar No<small class="text-danger">*</small></label>
                                    <input type="text" class="form-control" name="client_partner_aadhar" placeholder="Enter Aadhar No" value="<?php echo $e_cl_pt['client_partner_aadhar']; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <?php 
                                        $client_partner_appt_date="";
                                        if(!empty($e_cl_pt['client_partner_appt_date']) && $e_cl_pt['client_partner_appt_date']!="0000-00-00" && $e_cl_pt['client_partner_appt_date']!="1970-01-01")
                                            $client_partner_appt_date=date('Y-m-d', strtotime($e_cl_pt['client_partner_appt_date'])); 
                                    ?>
                                    <input type="date" class="form-control" name="client_partner_appt_date" placeholder="Enter Appointment Date" value="<?php echo $client_partner_appt_date; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <?php 
                                        $client_partner_date="";
                                        if(!empty($e_cl_pt['client_partner_date']) && $e_cl_pt['client_partner_date']!="0000-00-00" && $e_cl_pt['client_partner_date']!="1970-01-01")
                                            $client_partner_date=date('Y-m-d', strtotime($e_cl_pt['client_partner_date'])); 
                                    ?>
                                    <input type="date" class="form-control" name="client_partner_date" placeholder="Enter Cessation Date" value="<?php echo $client_partner_date; ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer text-right" style="width: 100%;">
                        <input type="hidden" name="clientId" value="<?php echo $clientId; ?>">
                        <input type="hidden" name="client_partner_id" value="<?php echo $e_cl_pt['client_partner_id']; ?>" required>
                        <button type="button" class="btn btn-danger text-left" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.edit_acts_checkbox').on('click', function(){
            ...
            $(selectedActsArr).each(function(i, val){
                ...
                selectedActsText+='<div class="col-md-3 getActModal" data-actid="'+selActId+'"><div class="box box-inverse box-primary"><div class="'+actClass+' box-head with-border"><h4 class="box-title"><strong>'+val+'</strong></h4></div></div></div>';
            });
    ...
    function checkedSelAct()
    {
        ...
        $(selectedActsArr).each(function(i, val){
            ...
            selectedActsText+='<div class="col-md-3 getActModal" data-actid="'+selActId+'"><div class="box box-inverse box-primary"><div class="box_head_cl '+actClass+' box-head with-border"><h4 class="box-title"><strong>'+val+'</strong></h4></div></div></div>';
        });
        ...
        $('#edit_add_client_group_form').on('submit', function(e){
            ...
            $.ajax({
                ...
                success : function(response) {
                    ...
                    if(resStatus==true)
                    {
                        $('#edit_clientCostCenter').val(mcost_center);
                        $('#edit_clientCategory').val(mcategory);
