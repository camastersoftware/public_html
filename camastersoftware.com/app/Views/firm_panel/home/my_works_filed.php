                                                                                                        ...
                                                                                                        <td class="column-13 text-center">
                                                                                                            <div class="btn-group">
                                                                                                                ...
                                                                                                                <div class="dropdown-menu" style="will-change: transform;">
                                                                                                                    <a class="dropdown-item" href="<?= base_url('work-time-sheet-list/'.$e_inc_row['workId']); ?>" >
        ...
        <div class="modal-content">
            <form action="" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?php echo base_url('my_works_filed'); ?>">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#due_act_sel').on('change', function(){
            ...
            window.location.href=base_url+"/my_works_filed?due_act_sel="+due_act_sel;
        });
