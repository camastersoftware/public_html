                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="errDate" id="errDate" value="<?= $errRepData['errDate']; ?>" required> 
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <!--        <input type="text" class="form-control" name="errReport" id="errReport" placeholder="Enter Report Title" value="<?//= $errRepData['errReport']; ?>" required> -->
                                <!--    </div>-->
                                <!--</div>-->
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="grid-Wrapper">
                                            <button type="button" class="clrBtn none <?php if($errRepData['errPriority']==1): ?>active<?php endif; ?>" data-clr="none" onclick="ColorPicker(1,'none',this);"></button>
                                            <button type="button" class="clrBtn yellow <?php if($errRepData['errPriority']==2): ?>active<?php endif; ?>" data-clr="#f0f58b7d" onclick="ColorPicker(2,'#f0f58b7d',this);"></button>
                                            <button type="button" class="clrBtn red <?php if($errRepData['errPriority']==3): ?>active<?php endif; ?>" data-clr="pink" onclick="ColorPicker(3,'pink',this);"></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
