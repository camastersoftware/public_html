                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?php echo base_url('all-employees-attendance-hours/'.$currMth); ?>">
                                <button type="button" class="waves-effect waves-light btn btn-sm btn-submit add_client_top mt-1">All Employees Attendance</button>
                            </a>
                            &nbsp;&nbsp;
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" style="will-change: transform;">
                                                        <a class="dropdown-item" href="<?php echo base_url('employee-attendance/'.$e_row['userId']); ?>" >Attendance</a>
                                                        <a class="dropdown-item" href="<?php echo base_url('employee-yearly-attendance-hours/'.$e_row['userId']); ?>" >Yearly Attendance</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
