        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border flexbox text-center">
                    <h4 class="box-title font-weight-bold"><?php echo $pageTitle." : ".$getUserData['userFullName']." (In ST/ET)"; ?></h4>
                    <div class="text-right flex-grow">
                        <a href="<?php echo base_url('employee-yearly-attendance-hours/'.$userId); ?>">
