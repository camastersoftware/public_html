                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            ...
                            &nbsp;&nbsp;
                            <a href="<?php echo base_url('all-employees-attendance/'.$mth); ?>">
                                                ...
                                                <tr class="row-1" width="7%">
                                                    ...
                                                    <?php if(!empty($generatedDateArr)): ?>
                                                        <?php foreach($generatedDateArr AS $e_dt): ?>
                                                            ...
                                                            <td class="column-1" nowrap <?php if(in_array($e_dt, $holidayDateArr) || $dayNo==6 || $dayNo==7): ?>style="background: #00549545 !important;"<?php endif; ?>>
                                                                <?php
                                                                    $totalHoursVal = "";
...
<script>
    $(document).ready(function(){
        ...
        $('#selMthAttend').on('change', function () {
            ...
            window.location.href=base_url+"/all-employees-attendance-hours/"+mth;
        });
    });
</script>
<?= $this->endSection(); ?>