                                ...
                                <?php if(!empty($getClientList)): ?>
                                    <?php foreach($getClientList AS $k_row => $e_row): ?>
                                        ...
                                        <?php
                                            ...
                                            if(!empty($e_row['regNo']))
                                                $regNoVal=$e_row['regNo'];
                                            else
                                                $regNoVal="N/A";
                                        ?>
        ...
        <div id="editClientModal<?php echo $k_row; ?>" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="<?php echo base_url('edit-client-pt-password'); ?>" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="pan_no" value="<?= $regNoVal; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
