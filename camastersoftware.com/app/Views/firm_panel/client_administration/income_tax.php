                                ...
                                <?php if(!empty($getClientList)): ?>
                                    <?php foreach($getClientList AS $k_row => $e_row): ?>
                                        ...
                                        <?php
                                            ...
                                            if(!empty($e_row['panNo']))
                                                $panNoVal=$e_row['panNo'];
                                            else
                                                $panNoVal="N/A";
                                        ?>
                                        ...
                                        <tr id="client_id_tr_<?php echo $e_row['clientId']; ?>">
                                            ...
                                            <td width="20%" nowrap>
                                                ...
                                                <a href="javascript:void(0);" data-toggle="tooltip" data-original-title="<?php echo $clientNameVar; ?>">
                                                    <?php
                                                        if(strlen($clientNameVar)>40)
                                                        {
                                                            echo substr($clientNameVar, 0, 40)."..";
                                                        }
                                                        else
                                                        {
                                                            echo $clientNameVar;
                                            ...
                                            <td class="text-center">
                                                <?php   
                                                    if($e_row['orgType']==8 || $e_row['orgType']==9)
                                                    {
        ...
        <div id="editClientModal<?php echo $k_row; ?>" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="<?php echo base_url('edit-client-it-password'); ?>" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="pan_no" value="<?= $panNoVal; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label>Password<small class="text-danger">*</small></label>
                                        <input type="text" class="form-control" name="login_password" id="login_password" placeholder="Enter Password" value="<?= $e_row['password']; ?>" required>
                                    </div>
                                </div>
        ...
        $('.deleteClientCredetials').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/delete-client-it-password';
                    $.post(postingUrl, 
                    {
                        clients_credetials_administration_id: clients_credetials_administration_id
                    },
                    function(data, status){
                        window.location.href=base_url+"/it-password";
                    });
