...
<style>
        ...
        <div id="updateSubGroup<?php echo $e_row['refSubGrpId']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <form action="<?php echo base_url('editRefSubGroups'); ?>" method="POST" enctype="multipart/form-data" >
    ...
    <div id="addSubGroup" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="<?php echo base_url('addRefSubGroups'); ?>" method="POST" enctype="multipart/form-data" >
                    <div class="modal-header">
        ...
        $('.deleteContGroup').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/deleteRefSubGroups';
                    $.post(postingUrl, 
                    {
                        sub_group_id: sub_group_id
                    },
                    function(data, status){
                        window.location.href=base_url+"/refSubGroups";
                    });
