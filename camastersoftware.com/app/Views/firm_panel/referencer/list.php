...
<?= $this->section('content'); ?>
                    ...
                    <div class="box-body">
                        <ul class="nav nav-tabs nav-tabs_hd nav-fill ml-15" role="tablist">
    						<li class="nav-item nav_tab_1"> 
    						    <a class="nav-link nav-link_hd active" href="<?php echo base_url('referncer'); ?>" role="tab">
    						...
    						<li class="nav-item nav_tab_2"> 
    						    <a class="nav-link nav-link_hd" href="<?php echo base_url('adminReferncer'); ?>" role="tab">
    						        <span class="hidden-xs-down ml-15">
    						            <span class="tabs_title font-weight-bold">
                                            ...
                                            <div class="col-md-6 col-md-6 col-sm-12 col-xs-12">
                                                <div class="form-group row mb-0">
                                                    <div class="col-md-4 col-md-4 col-sm-4 col-xs-4 text-center">
                                                        <a href="<?php echo base_url('refGroups'); ?>">
                                                    ...
                                                    <div class="col-md-4 col-md-4 col-sm-4 col-xs-4 text-center">
                                                        <a href="<?php echo base_url('refSubGroups'); ?>">
        ...
        <div id="updateReferncer<?php echo $e_row['referncerId']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <form action="<?php echo base_url('updateReferncer'); ?>" method="POST" enctype="multipart/form-data" >
    ...
    <div id="addReferncer" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="<?php echo base_url('addReferncer'); ?>" method="POST" enctype="multipart/form-data" >
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="ref_sub_group_id">Sub Group<span class="text-danger">*</span></label>
                                    <select class="custom-select form-control" name="ref_sub_group_id" id="ref_sub_group_id" >
                                        <option value="">Select Sub Group</option>
                                    </select> 
                                </div>
                            </div>
        ...
        $('.deleteReferncer').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/deleteReferncer';
                    $.post(postingUrl, 
                    {
                        referncerId: referncerId
                    },
                    function(data, status){
                        window.location.href=base_url+"/referncer";
                    });
...
<script type="text/javascript">
    ...
    function searchGroup($this)
    {
        ...
        window.location.href=base_url+"/referncer?group="+group_id;
    }
    ...
    function serachSubGroup($this)
    {
        ...
        window.location.href=base_url+"/referncer?group="+group_id+"&sub_group="+sub_group_id;
    }
