        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?=base_url('act-wise-quarter-tax-calendar')?>" id="filterForm" method="POST" >
                            <div class="row mb-10">
                                <div class="col-md-4">
                                    ...
                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable no-footer mt-20">
                                        <thead>
                                            <tr class="row-1">
                                                ...
                                                <th class="column-1">Apr-Jun</th>
                                                <th class="column-1">Jul-Sep</th>
                                                <th class="column-1">Oct-Dec</th>
                                                <th class="column-1">Jan-Mar</th>
                                            </tr>
                                        </thead>
                                                    ...
                                                    <?php if(in_array($ddfId, $ddfIDArr)): ?>
                                                        ...
                                                        <tr class="row-2">
                                                            ...
                                                            <?php for($qtr=4;$qtr<=15;$qtr += 3): ?>
                                                                ...
                                                                <?php
                                                                    $dueDate="";
                                                                    if(isset($dueDateForQtrWiseArr[$ddfId][$mth]))
                                                                    {
                                                                        $dueDateDataArr=$dueDateForQtrWiseArr[$ddfId][$mth];
