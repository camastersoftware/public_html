        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?=base_url('search_tax_calendar')?>" method="post" >
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a href="<?=base_url('reset_tax_calendar?type=2')?>">
                        ...
                        <div class="tab-content tabcontent-border p-15" id="myTabContent">
                            ...
                            <div class="tab-pane table-responsive <?php if($taxCalFinYearAdminCookie==$dueYear && $mth==$currMth): ?>show active<?php elseif($taxCalFinYearAdminCookie!=$dueYear && $mth==4): ?>show active<?php endif; ?>" id="<?php echo $mth_nm; ?>_tab" role="tabpanel" aria-labelledby="<?php echo $mth_nm; ?>-tab">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#radio_30').on('click', function(){
                window.location.href=base_url+"/tax_calendar";
            });
            
            $('#radio_32').on('click', function(){
                window.location.href=base_url+"/date_wise_tax_calendar";
            });
