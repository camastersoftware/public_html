                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                            ...
                            <li class="nav-item"> 
                                <a class="nav-link <?php if($taxCalFinYearAdminCookie==$dueYear && $m==$currMth && $monthNoVar==""): ?>active<?php elseif($taxCalFinYearAdminCookie!=$dueYear && $m==4 && $monthNoVar==""): ?>active<?php elseif($monthNoVar==$m && $monthNoVar!=""): ?>active<?php endif; ?>" id="<?php echo $mth_nm; ?>-tab" data-toggle="tab" href="#<?php echo $mth_nm; ?>_tab" role="tab" aria-controls="profile">
