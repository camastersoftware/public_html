                    ...
                    <div class="box-body">
                        <div class="row"> 
                            <div class="col-md-3 col-12 text-justify-center">
                                <a href="<?php echo base_url('act-wise-mth-tax-calendar'); ?>">
                            ...
                            <div class="col-md-3 col-12 text-justify-center">
                                <a href="<?php echo base_url('act-wise-quarter-tax-calendar'); ?>">
                                    <div class="box box-inverse box-primary box-card-home box-card-clr p_clr card_box_shape">
                                        <div class="box-body box-p_new menu_box_new">
                                            <p>Quaterly</p>
                                        </div>
                            ...
                            <div class="col-md-3 col-12 text-justify-center">
                                <a href="<?php echo base_url('act-wise-half-tax-calendar'); ?>">
                                    <div class="box box-inverse box-primary box-card-home box-card-clr p_clr card_box_shape">
                                        <div class="box-body box-p_new menu_box_new">
                                            <p>Half Yearly</p>
                                        </div>
                            ...
                            <div class="col-md-3 col-12 text-justify-center">
                                <a href="<?php echo base_url('act-wise-year-tax-calendar'); ?>">
                                    <div class="box box-inverse box-primary box-card-home box-card-clr p_clr card_box_shape">
                                        <div class="box-body box-p_new menu_box_new">
                                            <p>Yearly</p>
                                        </div>
