        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?=base_url('due-date-yr-summary-tax-calendar')?>" id="filterForm" method="POST" >
                            <div class="row mb-10">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-12 table-responsive">
                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable no-footer mt-20">
                                        ...
                                        <tbody class="row-hover">
                                            <?php if(!empty($ddfPeriodcityWiseArr)): ?>
                                                <?php foreach($ddfPeriodcityWiseArr AS $k_row=>$e_row): ?>
                                                
                                                    <?php $ddfId=$e_row['due_date_for_id']; ?>
                                                    <?php $ddfName=$e_row['due_date_for_name']; ?>
                                                    <?php $prdCtyId=$e_row['periodicity_id']; ?>
                                                    <?php $prdCtyName=$e_row['periodicity_name']; ?>
                                                    <?php $dpf=$e_row['dpf']; ?>
                                                    
                                                    <?php if(in_array($ddfId, $ddfIDArr)): ?>
                                                        <?php $isRecordsExists=true; ?>
                                                        <?php
                                                            $dueDateForDataArray=$dueDateForDataArr[$dpf];
                                                        ...
                                                        <tr class="row-2">
                                                            ...
                                                            <?php for($mt_no=1;$mt_no<13;$mt_no++): ?>
                                                                ...
                                                                <?php
                                                                    $dueDate="-";
                                                                    $ddPeriod="";
                                                                    if(isset($dueDateForMthWiseArr[$ddfId][$prdCtyId][$mth]))
                                                                    {
                                                                        $dueDateDataArr=$dueDateForMthWiseArr[$ddfId][$prdCtyId][$mth];
                                                                        
                                                                        $dueDateVal=$dueDateDataArr['extended_date'];
                                                                        $ddPeriod=$dueDateDataArr['ddPeriod'];
                                                                ...
                                                                <td class="text-center mthData">
                                                                    <?php if(!empty($ddPeriod)): ?>
                                                                        <span data-toggle="tooltip" data-original-title="Period : <?= $ddPeriod; ?>" style="cursor:pointer;">
                                                                            <?= $dueDate; ?>
                                                                        </span>
                                                                    <?php else: ?>
                                                                        <?= $dueDate; ?>
...
<?= $this->section('javacript'); ?>
    <script src="<?//= base_url('assets/js/dd-yr-tax-calendar-periodicity.js'); ?>"></script>
<?= $this->endSection(); ?>