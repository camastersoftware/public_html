        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?=base_url('act-wise-half-tax-calendar')?>" id="filterForm" method="POST" >
                            <div class="row mb-10">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" id="periodicityVal" name="periodicityVal">
                                                ...
                                                <option value="4" selected >Half Yearly</option>
                                    ...
                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable no-footer mt-20">
                                        <thead>
                                            <tr class="row-1">
                                                ...
                                                <th class="column-1">Apr-Sep</th>
                                                <th class="column-1">Oct-Mar</th>
                                            </tr>
                                        </thead>
                                                        ...
                                                        <tr class="row-2">
                                                            <td class="ddfColTd">
                                                                <a href="javascript:void(0);" data-toggle="tooltip" data-original-title="<?= $ddfName; ?>">
                                                                    ...
                                                                    ?>
                                                                   <span class="due_date_for_name"><?= $ddfName; ?></span>
                                                                </a>
                                                                <br>
                                                            ...
                                                            <?php
                                                                $dueDate="";
                                                                if(isset($dueDateForHalfWiseArr[$ddfId][4]))
                                                                {
                                                                    $dueDateDataArr=$dueDateForHalfWiseArr[$ddfId][4];
                                                            ...
                                                            <?php
                                                                $dueDate="";
                                                                if(isset($dueDateForHalfWiseArr[$ddfId][10]))
                                                                {
                                                                    $dueDateDataArr=$dueDateForHalfWiseArr[$ddfId][10];
