                    ...
                    <div class="box-body">
                        <ul class="nav nav-tabs nav-tabs_hd nav-fill ml-15" role="tablist">
    						...
    						<li class="nav-item nav_tab_2"> 
    						    <a class="nav-link nav-link_hd" href="<?php echo base_url('assignByMeList'); ?>" role="tab">
    						        <span class="hidden-xs-down ml-15">
    						            <span class="tabs_title font-weight-bold">
                        ...
                        <div class="tab-content tabcontent-border pl-15 pr-15 pb-15">
                            <div class="tab-pane fade active show" id="td_list_for_me" role="tabpanel">
                                                ...
                                                <div class="form-group row mb-0">
                                                    ...
                                                    <div class="col-md-4 col-md-4 col-sm-4 col-xs-4 text-center">
                                                        <?php if(!empty($listToMeArr)): ?>
                                                            <select class="form-control select2" name="toMeUserId" id="toMeUserId" onchange="searchStaffToMe(this);" style="width:100%;margin-top: 4px;" required>
                                                                <option value="">Assigned By</option>
                                                                <?php if(!empty($getUserList)): ?>
                                                                    <?php foreach($getUserList AS $e_u): ?>
                                                                        <option value="<?= $e_u['userId']; ?>" <?php if($toMeUserId==$e_u['userId']): ?>selected<?php endif; ?> ><?= $e_u['userFullName']; ?></option>
                                                                    <?php endforeach; ?>
                                                                <?php endif; ?>
                                                            </select> 
                                                        <?php endif; ?>
                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            ...
                                            <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item"> 
                                                    <a class="nav-link <?php //if($m==$currMth): ?>active<?php //endif; ?>" id="<?php //echo $mth_nm; ?>-tab1" data-toggle="tab" href="#<?php //echo $mth_nm; ?>_tab1" role="tab" aria-controls="profile">
                                            ...
                                            <div class="tab-content tabcontent-border p-15" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade table-responsive <?php //if($mth==$currMth): ?>show active<?php //endif; ?>" id="<?php //echo $mth_nm; ?>_tab1" role="tabpanel" aria-labelledby="<?php //echo $mth_nm; ?>-tab">
                                                    -->
                                                                			...
                                                                			<td class="text-center">
                                                                			    ...
                                                                			    <div class="btn-group">
                                                                                    ...
                                                                                    <div class="dropdown-menu" style="will-change: transform;">
                                                                                        <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal" data-target="#updateTDListToMe<?php echo $e_row['tdId']; ?>">Edit</a>
                                                                                    </div>
                                                                                </div>
                            ...
                            <div class="tab-pane fade" id="td_list_by_me" role="tabpanel"></div>
                        </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="<?php echo base_url('addTDList'); ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="modal-footer text-right" style="width: 100%;">
                        <input type="hidden" name="tdRedirectTo" value="myToDo" />
...
<script type="text/javascript">
    ...
    function searchStaffByMe($this)
    {
        ...
        window.location.href=base_url+"/todolist?assignByMeList="+userId;
    }
