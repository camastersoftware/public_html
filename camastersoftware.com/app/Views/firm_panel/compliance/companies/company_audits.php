                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            ...
                            &nbsp;&nbsp;
                            <a href="<?php echo base_url('companies-act'); ?>">
                                                                                                    ...
                                                                                                    <?php if($signature_date=="-"): ?>
                                                                                                        ...
                                                                                                        <tr class="row-1 tbl_row_clr">
                                                                                                            ...
                                                                                                            <td class="column-3 <?= $rowColor; ?>" width="15%" nowrap>
                                                                                                                ...
                                                                                                                ?>
                                                                                                                <a href="<?php echo base_url('company-audit-work-form/'.$e_inc_row['workId']); ?>">
                                                                                                                    <?php 
                                                                                                            ...
                                                                                                            <td class="column-9 text-center <?php if($signature_date!='-'): ?>hasCompleted<?php endif; ?>" width="10%">
                                                                                                            ...
                                                                                                            <td class="column-10 text-center <?php if($udinDate!='-'): ?>hasCompleted<?php endif; ?>" width="7%">
                                                                                                                <?php echo $udinDate; ?>
                                                                                                            </td>
