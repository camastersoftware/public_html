                        ...
                        <div class="row">
                            <div class="col-md-12 mt-30">
                                <div class="row">
                                    <div class="col-md-3" id="">
                                        <div class="form-group">
                                            <label for="cmpyAgmDate">Date of AGM :</label>
                                            <input type="date" class="form-control" name="cmpyAgmDate" id="cmpyAgmDate" value="<?= (check_valid_date($workArr['cmpyAgmDate'])) ? date('Y-m-d', strtotime($workArr['cmpyAgmDate'])) : "" ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="cmpyReceiptNo">Receipt Number :</label>
                                            <input type="text" class="form-control" name="cmpyReceiptNo" id="cmpyReceiptNo" value="<?php echo $workArr['cmpyReceiptNo']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="cmpyReceiptAmt">Receipt Amount :</label>
                                            <input type="text" class="form-control" name="cmpyReceiptAmt" id="cmpyReceiptAmt" value="<?php echo $workArr['cmpyReceiptAmt']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="cmpyReceiptDate">Receipt Date :</label>
                                            <input type="date" class="form-control" name="cmpyReceiptDate" id="cmpyReceiptDate" value="<?= (check_valid_date($workArr['cmpyReceiptDate'])) ? date('Y-m-d', strtotime($workArr['cmpyReceiptDate'])) : "" ?>">
                                        </div>
                                    </div>	
                                </div> 
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('body').on('submit', '.work_data_form', function(e){
            ...
            var postingUrl = base_url+'/company-work-form/'+workId;
