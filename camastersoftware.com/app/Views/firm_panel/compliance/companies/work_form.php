        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                ...
                <div class="box-body card_bg_format">
                    <form action="<?= base_url('company-work-form/'.$workId); ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                                ...
                                <div class="form-group row form_bg_format">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <?php
                                                                        $cmpyAgmDate="";
                                                                        if(check_valid_date($workArr['cmpyAgmDate']))
                                                                            $cmpyAgmDate=date('Y-m-d', strtotime($workArr['cmpyAgmDate']));
                                                                    ?>
                                                                    <label for="cmpyAgmDate">Date of AGM :</label>
                                                                    <input type="date" class="form-control" name="cmpyAgmDate" id="cmpyAgmDate" value="<?= $cmpyAgmDate; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="state due-month">
                                                    <h4 class="text-white font-weight-bold m-0">Companies Act Scrutiny</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group row mb-0">
                                                            <div class="col-md-6">
                                                                <label for="isScrutiny">Whether selected for Companies Act Scrutiny :</label>
                                                            </div>
                                                            <div class="col-md-6">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('input:radio[name="isDefectiveReturn"]:checked').trigger('click');
