                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url($secPrefixUrl.'-ddf-pending/'.$ddfId); ?>">
                                <button class="btn btn-sm btn-success" data-toggle="tooltip" data-original-title="Returns Pending">
                                    Pending
                                </button>
                            </a>
                            &nbsp;&nbsp;
                                                                ...
                                                                <td class="column-3 <?= $rowColor; ?>" width="15%" nowrap>
                                                                    ...
                                                                    <div class="tooltip-div">
                                                                        ...
                                                                        <span class='tooltipElem tooltipClr'>
                                                                            ...
                                                                            <?php else: ?>
                                                                                <a href="javascript:void(0);" data-toggle="modal" data-target="#updateModal<?= $e_inc_row['workId']; ?>">
                                                                                    <button type="button" class="waves-effect waves-light btn btn-sm btn-success">
                                                                                        <i class="fa fa-file fa-2x"></i>
                                                                                        <span class="fs_14">Work</span>
                                                                                    </button>
                                                                    ...
                                                                    <?php if($due_date_type==6): ?>
                                                                        <!-- Modal -->
                                                                        <div id="updateModal<?= $e_inc_row['workId']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <div class="row">
                                                                                                <div class="col-md-12 col-lg-12 text-center">
                                                                                                    <h4 class="font-weight-bold"><?= $clientNameVar; ?></h4>
                                                                                                </div>
                                                                                                <div class="col-md-6 col-lg-6 text-left">
                                                                                                    <span class="font-weight-bold">Group No :&nbsp;</span>
                                                                                                    <span>
                                                                                                        <?= (!empty($e_inc_row['client_group_number'])) ? $e_inc_row['client_group_number'] : "N/A"; ?>
                                                                                                    </span>
                                                                                                </div>
                                                                                                <div class="col-md-6 col-lg-6 text-right">
                                                                                                    <span class="font-weight-bold">DIN :&nbsp;</span>
                                                                                                    <span>
                                                                                                        <?= (!empty($e_inc_row['client_document_number'])) ? $e_inc_row['client_document_number'] : "N/A"; ?>
                                                                                                    </span>
                                                                                                </div>
                                                                                                <div class="col-md-12 col-lg-12 text-center">
                                                                                                    <hr>
                                                                                                        ...
                                                                                                        <select class="custom-select form-control" name="dirKycAllotedTo" id="dirKycAllotedTo" >
                                                                                                            ...
                                                                                                            <?php if(!empty($getUserList)): ?>
                                                                                                                <?php foreach($getUserList AS $e_user): ?>
                                                                                                                    <?php 
                                                                                                                        $selAllotedTo="";
                                                                                                                        if($e_inc_row['dirKycAllotedTo']==$e_user['userId'])
                                                                                                ...
                                                                                                <div class="col-md-6 col-lg-6">
                                                                                                    <div class="form-group text-left">
                                                                                                        ...
                                                                                                        <input type="text" class="form-control" name="dirKycMob" id="dirKycMob" value="<?= $e_inc_row['dirKycMob']; ?>">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-6 col-lg-6">
                                                                                                    <div class="form-group text-left">
                                                                                                        <label>Email Address</label>
                                                                                                        <input type="text" class="form-control" name="dirKycEmail" id="dirKycEmail" value="<?= $e_inc_row['dirKycEmail']; ?>">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-6 col-lg-6">
                                                                                                    <div class="form-group text-left">
                                                                                                        <label>Updated On</label>
                                                                                                        <input type="date" class="form-control" name="dirKycUpdatedOn" id="dirKycUpdatedOn" value="<?= (check_valid_date($e_inc_row['dirKycUpdatedOn'])) ? date("Y-m-d", strtotime($e_inc_row['dirKycUpdatedOn'])) : ""; ?>" >
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-6 col-lg-6">
                                                                                                    <div class="form-group text-left">
                                                                                                        <label>SRN No</label>
                                                                                                        <input type="text" class="form-control" name="dirKycSrnNo" id="dirKycSrnNo" value="<?= $e_inc_row['dirKycSrnNo']; ?>">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-6 col-lg-6">
                                                                                                    <div class="form-group text-left">
                                                                                                        <label>Approved On</label>
                                                                                                        <input type="date" class="form-control" name="dirKycApprovedOn" id="dirKycApprovedOn" value="<?= (check_valid_date($e_inc_row['dirKycApprovedOn'])) ? date("Y-m-d", strtotime($e_inc_row['dirKycApprovedOn'])) : ""; ?>">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="modal-footer text-right" style="width: 100%;">
                                                                                            <input type="hidden" name="clientId" id="clientId" value="<?= $e_inc_row['clientId']; ?>">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?= base_url('search-'.$secPrefixUrl.'-filter'); ?>" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    <button type="button" class="btn btn-danger text-left" data-dismiss="modal">Close</button>
                    <a href="<?= base_url('reset-'.$secPrefixUrl.'-filter?ftr_type=2&ddfId='.$ddfId); ?>">
                        <button type="button" class="btn btn-warning text-left" >Reset</button>
                    </a>
                    <input type="hidden" name="ddfId" id="ddfId" value="<?= $ddfId; ?>" >
                    <input type="hidden" name="ftr_type" id="ftr_type" value="2" >
                    <button type="submit" name="submit" class="btn btn-success text-left">Submit</button>
                </div>
            </form>
        </div>
