        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border flexbox">
                    ...
                    <a href="<?php echo base_url('company_audits'); ?>"><button type="button" class="waves-effect waves-light btn btn-sm btn-dark" >Back</button></a>
                </div>
                <!-- /.box-header -->
                                ...
                                <div class="row">
                                    <div class="col-md-3" id="">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="cmpyAuditAgmDate" id="cmpyAuditAgmDate" value="<?= (check_valid_date($workArr['cmpyAuditAgmDate'])) ? date('Y-m-d', strtotime($workArr['cmpyAuditAgmDate'])) : "" ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="cmpyAuditorName">Name of the Auditor :</label>
                                            <input type="text" class="form-control" name="cmpyAuditorName" id="cmpyAuditorName" value="<?php echo $workArr['cmpyAuditorName']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="cmpyAuditDate">Audit Date :</label>
                                            <input type="date" class="form-control" name="cmpyAuditDate" id="cmpyAuditDate" value="<?= (check_valid_date($workArr['cmpyAuditDate'])) ? date('Y-m-d', strtotime($workArr['cmpyAuditDate'])) : "" ?>">
                                        </div>
                                    </div>	
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="cmpyAuditUDIN">UDIN :</label>
                                            <input type="text" class="form-control" name="cmpyAuditUDIN" id="cmpyAuditUDIN" value="<?php echo $workArr['cmpyAuditUDIN']; ?>">
                                        </div>
                                    </div>
                                </div> 
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('body').on('submit', '.work_data_form', function(e){
            ...
            var postingUrl = base_url+'/company-audit-work-form/'+workId;
