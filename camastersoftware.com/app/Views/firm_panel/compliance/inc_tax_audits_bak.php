	...
	<div class="row"> 
        <div class="col-12">
            ...
            <div class="box box-default">
                ...
                <div class="text-right mt-3 mr-20">
                                                    ...
                                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                                        ...
                                                        <thead>
                                                            <tr class="row-1">
                                                                ...
                                                                <th class="column-9" colspan="2">PROF.BILLING</th>
                                                            ...
                                                            <tr class="row-1">
                                                                ...
                                                                <th class="column-12">TYPE</th>
                                                                <th class="column-13">Done</th>
                                                                ...
                                                                <?php if(!empty($mthTaxPayerClientArray)): ?>
                                                                    <?php foreach($mthTaxPayerClientArray AS $e_inc_row): ?>
                                                                        <tr class="row-1">
                                                                            ...
                                                                            <td class="column-3">
                                                                                <a href="<?php echo base_url('admin/income_tax/audit_work_form/'.$e_inc_row['workId']); ?>">
                                                                            ...
                                                                            <td class="column-10">
                                                                                <?php echo $e_inc_row['set_prepared_by']; ?>
                                                                            </td>
        ...
        <div class="modal-content">
            <form action="" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?php echo base_url('admin/inc_tax_returns'); ?>">
