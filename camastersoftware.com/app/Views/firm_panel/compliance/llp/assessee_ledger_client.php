                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?php echo base_url('llp-assessee-ledger'); ?>">
                                        ...
                                        <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                            <thead>
                                                <tr class="row-1">
                                                    ...
                                                    <th class="column-6">WARD</th>
                                                    <th class="column-6">TOTAL</th>
                                                    <th class="column-6">S.ASST</th>
                                                    <th class="column-8">REFUND</th>
                                                    <th class="column-8">RECV.</th>
                                                ...
                                                <tr class="row-1">
                                                    ...
                                                    <th class="column-7">TAX</th>
                                                    <th class="column-11">CLAIMED</th>
                                                    <th class="column-11">ON</th>
                                                ...
                                                <?php if(!empty($workDataArr)): ?>
                                                    <?php foreach($workDataArr AS $e_inc_row): ?>
                                                        ...
                                                        <tr class="row-1">
                                                            ...
                                                            <td class="column-9 text-center"></td>
                                                            <td class="column-9">
                                                            ...
                                                            <td class="column-9">
                                                                <?php if(!empty($e_inc_row['selfAssessmentTax'])): ?>
                                                                    <div class="text-right">
                                                                        <?php if($e_inc_row['selfAssessmentTax']>=0): ?>
                                                                            <?= amount_format($e_inc_row['selfAssessmentTax']); ?>
                                                                        <?php else: ?>
                                                                            <?= "(".amount_format(abs((float)$e_inc_row['selfAssessmentTax'])).")"; ?>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                <?php else: ?>
                                                                    <div class="text-center">-</div>
                                                            ...
                                                            <td class="column-9">
                                                                <?php if(!empty($e_inc_row['refundDueVal'])): ?>
                                                                    <div class="text-right">
                                                                        <?php if($e_inc_row['refundDueVal']>=0): ?>
                                                                            <?= amount_format($e_inc_row['refundDueVal']); ?>
                                                                        <?php else: ?>
                                                                            <?= "(".amount_format(abs((float)$e_inc_row['refundDueVal'])).")"; ?>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                <?php else: ?>
                                                                    <div class="text-center">-</div>
                                                            ...
                                                            <td class="column-9 text-center">
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu" style="will-change: transform;">
                                                                        <a class="dropdown-item" href="<?php echo base_url('llp-work-form/'.$e_inc_row['workId']); ?>">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
