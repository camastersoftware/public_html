        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                ...
                <div class="box-body card_bg_format">
                    <form action="<?= base_url('llp-work-form/'.$workId); ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                                ...
                                <div class="form-group row form_bg_format">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-lg-4 text-left">
                                                <span class="font-weight-bold">LLPIN :&nbsp;</span>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <?php if(!empty($ackUploadFile)): ?>
                                                                        <div class="col-md-3">
                                                                            <?php $ackUploadFilePath = base_url("uploads/ca_firm_".$sessCaFirmId."/compliance/llp/".$ackUploadFile); ?>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="state due-month">
                                                    <h4 class="text-white font-weight-bold m-0">LLP Scrutiny</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group row mb-0">
                                                            <div class="col-md-6">
                                                                <label for="isScrutiny">Whether selected for LLP Scrutiny :</label>
                                                            </div>
                                                            <div class="col-md-6">
        ...
        $('body').on('click', '.deleteUploadedFile', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url : base_url+'/delete-llp-act-ack-file',
                        type : 'POST',
                        data : {
                            'workId':workId
                        },
