                                                    ...
                                                    <td width="5%">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" style="will-change: transform;">
                                                                <a class="dropdown-item" href="<?= base_url('edit-llp-firm-deed/'.$clientId.'/'.$e_row['firmDeedId']); ?>">Edit</a>
                                                                <a class="dropdown-item" href="<?= base_url('view-llp-firm-deed/'.$clientId.'/'.$e_row['firmDeedId']); ?>">View</a>
        ...
        $('.deletePtFirm').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/delete-llp-firm-deed';
                    $.post(postingUrl, 
                    {
                        firmDeedId: firmDeedId
                    },
                    function(data, status){
                        window.location.href=base_url+"/llp-firm-deeds/"+clientId;
                    });
