        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url('llp-firm-deeds/'.$clientId); ?>">
                ...
                <div class="box-body p-10">
                    <form action="<?php echo base_url('edit-llp-firm-deed'); ?>" method="POST" >
                                        ...
                                        <div class="form-group row">
                                                        ...
                                                        <select class="custom-select form-control" name="deedType" >
                                                            ...
                                                            <?php if(!empty($deedTypeArr)): ?>
                                                                <?php foreach($deedTypeArr AS $e_deed): ?>
                                                                    <option value="<?php echo $e_deed['deedTypeId']; ?>" <?php if($e_deed['deedTypeId']==$ptFirmDeedArr['deedType']): ?> selected <?php endif; ?> ><?php echo $e_deed['deedTypeName']; ?></option>
                                                                <?php endforeach; ?>
                                                            <?php endif; ?>
                                                        </select> 
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="executionDate" id="executionDate" value="<?= (check_valid_date($ptFirmDeedArr['executionDate'])) ? $ptFirmDeedArr['executionDate']:""; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="effectiveDate" id="effectiveDate" value="<?= (check_valid_date($ptFirmDeedArr['effectiveDate'])) ? $ptFirmDeedArr['effectiveDate']:""; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                        ...
                                                        <select class="custom-select form-control" name="formNumber" >
                                                            ...
                                                            <?php if(!empty($formNoArr)): ?>
                                                                <?php foreach($formNoArr AS $e_formno): ?>
                                                                    <option value="<?php echo $e_formno['formNumberId']; ?>" <?php if($e_formno['formNumberId']==$ptFirmDeedArr['formNumber']): ?> selected <?php endif; ?>><?php echo $e_formno['formNumber']; ?></option>
                                                                <?php endforeach; ?>
                                                            <?php endif; ?>
                                                        </select> 
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="formFiledOn" id="formFiledOn" value="<?= (check_valid_date($ptFirmDeedArr['formFiledOn'])) ? $ptFirmDeedArr['formFiledOn']:""; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" name="amountPaid" id="amountPaid" value="<?= $ptFirmDeedArr['amountPaid']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" name="registrationNumber" id="registrationNumber" value="<?= $ptFirmDeedArr['registrationNumber']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="registrationOn" id="registrationOn" value="<?= (check_valid_date($ptFirmDeedArr['registrationOn'])) ? $ptFirmDeedArr['registrationOn']:""; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="extractRecvdOn" id="extractRecvdOn" value="<?= (check_valid_date($ptFirmDeedArr['extractRecvdOn'])) ? $ptFirmDeedArr['extractRecvdOn']:""; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="registeredAddress" placeholder="Enter Registered Address"><?= $ptFirmDeedArr['registeredAddress']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="adminOfficeAddress" placeholder="Enter Administrative Office Address"><?= $ptFirmDeedArr['adminOfficeAddress']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="factoryAddress" placeholder="Enter Factory Address"><?= $ptFirmDeedArr['factoryAddress']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="remarks" placeholder="Enter Changes in brief (Remarks)"><?= $ptFirmDeedArr['remarks']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12 mt-20">
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 text-center">
                                        ...
                                        <input type="hidden" name="firmDeedId" id="firmDeedId" value="<?= $ptFirmDeedArr['firmDeedId']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<input type="hidden" id="partnerRow" value='
    <tr class="row-1 partnerRow">
        ...
        <td class="column-5 text-center">
            <input type="hidden" name="firmPartnerId[]">
            <button type="button" class="waves-effect waves-light btn btn-sm btn-danger deletePartner">
                <i class="fa fa-minus"></i>
            </button>
        </td>
