                                        ...
                                        <?php if(!empty($getClientList)): ?>
                                            <?php foreach($getClientList AS $e_row): ?>
                                                <tr id="client_id_tr_<?php echo $e_row['clientId']; ?>">
                                                    ...
                                                    <td nowrap>
                                                        <a href="<?php echo base_url('llp-assessee-ledger-client/'.$e_row['clientId']); ?>" >
                                                            <?php
                                                                if($e_row['orgType']==8)
                                                                {
                                                                    if(!empty($e_row['clientBussOrganisation']))
                                                                        echo $e_row['clientName']." (".$e_row['clientBussOrganisation'].")";
                                                                    else
