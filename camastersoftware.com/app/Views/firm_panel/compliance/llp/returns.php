                                                                                                    ...
                                                                                                    <?php if($eFillingDate=='-'): ?>
                                                                                                        ...
                                                                                                        <tr class="row-1 tbl_row_clr" >
                                                                                                            ...
                                                                                                            <td class="column-3 <?= $rowColor; ?>" width="15%" nowrap>
                                                                                                                ...
                                                                                                                ?>
                                                                                                                <a href="<?php echo base_url('llp-work-form/'.$e_inc_row['workId']); ?>" data-toggle="tooltip" data-original-title="<?php echo $clientNameVar; ?>">
        ...
        <div class="modal-content">
            <form action="" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?php echo base_url('llp-returns'); ?>">
