                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?php echo base_url('llp-register-section'); ?>">
                                            ...
                                            <?php foreach($workDataArr AS $e_inc_row): ?>
                                                ...
                                                <tr class="row-1">
                                                    ...
                                                    <td class="column-2">
                                                        ...
                                                        ?>
                                                         <a href="<?= base_url('llp-work-form/'.$e_inc_row['workId']); ?>" data-toggle="tooltip" data-original-title="<?php echo $clientNameVar; ?>">
                                                            <?php 
