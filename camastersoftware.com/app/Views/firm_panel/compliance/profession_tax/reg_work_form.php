                                ...
                                <div class="form-group row form_bg_format">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <?php
                                                                    $eFillingDate=(check_valid_date($workArr['eFillingDate'])) ? date("Y-m-d", strtotime($workArr['eFillingDate'])) : "";
                                                                ?>
                                                                <div class="form-group row">
                                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <?php
                                                                    $verificationDate=(check_valid_date($workArr['verificationDate'])) ? date("Y-m-d", strtotime($workArr['verificationDate'])) : "";
                                                                ?>
                                                                <div class="form-group row">
                                                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="state due-month">
                                                    <h4 class="text-white font-weight-bold m-0">Profession Tax (Regn) Scrutiny</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group row mb-0">
                                                            <div class="col-md-6">
                                                                <label for="isScrutiny">Whether selected for Profession Tax (Regn) Scrutiny :</label>
                                                            </div>
                                                            <div class="col-md-6">
