                                        ...
                                        <div class="form-group row">
                                                        ...
                                                        <select class="custom-select form-control" name="deedType" >
                                                            ...
                                                            <?php if(!empty($deedTypeArr)): ?>
                                                                <?php foreach($deedTypeArr AS $e_deed): ?>
                                                                    <option value="<?php echo $e_deed['deedTypeId']; ?>"><?php echo $e_deed['deedTypeName']; ?></option>
                                                                <?php endforeach; ?>
                                                            <?php endif; ?>
                                                        </select> 
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="executionDate" id="executionDate">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group row">
                                                        ...
                                                        <select class="custom-select form-control" name="formNumber" >
                                                            ...
                                                            <?php if(!empty($formNoArr)): ?>
                                                                <?php foreach($formNoArr AS $e_formno): ?>
                                                                    <option value="<?php echo $e_formno['formNumberId']; ?>"><?php echo $e_formno['formNumber']; ?></option>
                                                                <?php endforeach; ?>
                                                            <?php endif; ?>
                                                        </select> 
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="formFiledOn" id="formFiledOn">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="registrationOn" id="registrationOn">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control" name="extractRecvdOn" id="extractRecvdOn">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-pane fade show active" id="apr_tab" role="tabpanel" aria-labelledby="apr-tab">
                                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                                        ...
                                                        <tbody class="row-hover partnerTbody"></tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="registeredAddress" placeholder="Enter Registered Address"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="adminOfficeAddress" placeholder="Enter Administrative Office Address"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="factoryAddress" placeholder="Enter Factory Address"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="remarks" placeholder="Enter Changes in brief (Remarks)"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
