        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                ...
                <div class="box-body wizard-content">
                    <form action="" class="tab-wizard wizard-circle work_data_form">
                        <!-- Step 1 -->
                        <h6>Work Allocation</h6>
                        <section>
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="clientName" id="clientName" value="<?php echo $workClientName; ?>" readonly>
                                            </div>
                                        </div>
                                        <!--
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="pmtAmountSuggested">Amount Suggested :</label>
                                                <input class="form-control" type="text" name="pmtAmountSuggested" id="pmtAmountSuggested" placeholder="Enter Amount Suggested" value="<?php echo $workArr['pmtAmountSuggested']; ?>" >
                                            </div>
                                        </div>
                                        -->
                                    </div> 
                                ...
                                <div class="col-md-6 mt-30">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="pmtJuniorId">Junior Alloction:</label>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="pmtApproved">Whether Approved :</label>
                                            </div>
                                            <div class="form-group">
                                                <input type="radio" name="pmtApproved" id="pmtApprovedYes" class="radio-col-primary" value="1" <?php if($workArr['pmtApproved']=="1"): ?>checked<?php endif; ?> />
                                                <label for="pmtApprovedYes">Yes</label>
                                                <input type="radio" name="pmtApproved" id="pmtApprovedNo" class="radio-col-success" value="2" <?php if($workArr['pmtApproved']=="2" || $workArr['pmtApproved']=="0"): ?>checked<?php endif; ?> />
                                                <label for="pmtApprovedNo">No</label>
                                            </div>
                                        </div>
                                        
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label for="pmtNewAmt">New Amount :</label>
                                                <input class="form-control" type="text" name="pmtNewAmt" id="pmtNewAmt" placeholder="Enter New Amount" value="<?php echo $workArr['pmtNewAmt']; ?>" >
                                                <input type="hidden" name="clientId" id="clientId" value="<?php echo $workArr['clientId']; ?>">
                                            </div>
                                        </div>
                                        -->
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="state due-month">
                                                            <label>Select Advance Tax Period</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                                        <thead>
                                                            <tr class="row-1">
                                                                ...
                                                                <th class="column-3">Periodicity</th>
                                                                        ...
                                                                        <td class="column-6">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <div class="dropdown-menu" style="will-change: transform;">
                                                                                    <a class="dropdown-item payable_modal_btn" href="javascript:void(0);" data-id="<?php echo $e_row['workId']; ?>" data-amt_approved="<?php echo $e_row['amtApproved']; ?>" >Amount Payable</a>
                                                    ...
                                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                                        <thead>
                                                            <tr class="row-1">
                                                                ...
                                                                <th class="column-4">Period</th>
                                                                <th class="column-3">Attoted To</th>
                                                        ...
                                                        <?php if(!empty($workDataArr) && in_array(1, $pmtActiveArr)): ?>
                                                            <?php foreach($workDataArr AS $e_row): ?>
                                                                ...
                                                                <tr class="row-1">	
                                                                    <td class="column-1"><?php echo $p; ?></td>
                                                                    <td class="column-2">
                                                                        <?php echo date('d-m-Y', strtotime($e_row['extended_date'])); ?>
                                                                    </td>
                                                                    <td class="column-4" nowrap>
                                                                    ...
                                                                    <td class="column-5">
                                                                        <?php echo $e_row['amtPaid']; ?>
                                                                    </td>
                                                                    <td class="column-7">
                                                                        <?php echo date('d-m-Y', strtotime($e_row['pmtDate'])); ?>
                                                                    </td>
                                                                    <td class="column-9">
                                                                        <button type="button" class="waves-effect waves-light btn btn-sm btn-danger delPayment" data-id="<?php echo $e_row['workId']; ?>">Delete</button>
                                                                    </td>
                                                                </tr>
                                                                <?php $p++; ?>
                                                                <?php endif; ?>
