                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url('inc-tax-certificates'); ?>">
                                                                                ...
                                                                                <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                                                                    <thead>
                                                                                        <tr class="row-1">
                                                                                            ...
                                                                                            <th class="column-5" width="14%" colspan="2">Alloted to</th>
                                                                                            <th class="column-6" width="15%" colspan="2">Completed</th>
                                                                                                    ...
                                                                                                    <tr class="row-1 tbl_row_clr">
                                                                                                        ...
                                                                                                        <td class="column-3 <?= $rowColor; ?>" width="15%" nowrap>
                                                                                                            ...
                                                                                                            <div class="tooltip-div">
                                                                                                                <?php //echo base_url('income_tax/work_form/'.$e_inc_row['workId']); ?>
                                                                                                                <a href="javascript:void(0);" class="has-tooltip" data-original-title="<?php echo $clientNameVar; ?>">
                                                                                                                ...
                                                                                                                <span class='tooltipElem tooltipClr'>
                                                                                                        			<span class="small text-bold"><?php echo $clientNameVar; ?></span>
                                                                                                        			<br>
                                                                                                        			<a href="<?php echo base_url('client/edit_client/'.$e_inc_row['clientId']); ?>">
...
<div id="Modalfilter-intax" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?= base_url('search-inc-tax-certificates'); ?>" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?php echo base_url('reset-inc-tax-certificates?ftr_type=2'); ?>">
