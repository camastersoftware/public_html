                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url('inc-tax-certificates-filed'); ?>">
                                                                                                ...
                                                                                                <?php foreach($mthDDFDueDateForClientArray AS $e_inc_row): ?>
                                                                                                    ...
                                                                                                    <tr class="row-1 tbl_row_clr" >
                                                                                                        ...
                                                                                                        <td class="column-3 <?= $rowColor; ?>" width="15%" nowrap>
                                                                                                            <?php 
                                                                                                                // if($e_inc_row['orgType']==8 || $e_inc_row['orgType']==9 || $e_inc_row['orgType']==22)
        ...
        <div class="modal-content">
            <form action="<?= base_url('search-inc-tax-certificates'); ?>" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?php echo base_url('reset-inc-tax-certificates?ftr_type=1'); ?>">
