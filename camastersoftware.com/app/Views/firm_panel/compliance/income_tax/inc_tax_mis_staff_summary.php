                ...
                <div class="box">
                    <div class="box-header with-border flexbox">
                        ...
                        <div class="text-right flex-grow">
                            <a href="<?= base_url('inc_tax_mis_menu'); ?>">
                        ...
                        <div class="tab-content tabcontent-border p-5" id="myTabContent">
                            ...
                            <div class="tab-pane fade table-responsive show active" id="total_mis_returns_tab" role="tabpanel" aria-labelledby="total_mis_returns_tab">
                                ...
                                <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable no-footer mt-20">
                                    <thead>
                                        <tr class="row-1">
                                            <th class="column-1" width="24%">Staff Name</th>
                                    ...
                                    <tbody class="row-hover">
                                        ...
                                        <?php if(!empty($getUserList)): ?>
                                            <?php foreach($getUserList AS $k_row=>$e_row): ?>
                                                
                                                <?php $totalMisCount=0; ?>
                                                <?php $misUserId=$e_row['userId']; ?>
                                                <?php $misUserName=$e_row['userFullName']; ?>
                                                
                                                <?php if(in_array($misUserId, $staffIDArr)): ?>
                                                    <?php $isRecordsExists=true; ?>
                                                    <tr class="row-2">
                                                        <td class="ddfColTd" nowrap width="24%">
                                                            <a href="javascript:void(0);" data-toggle="tooltip" data-original-title="<?= $misUserName; ?>">
                                                                <?php
                                                                    if(strlen($misUserName)>20)
                                                                    {
                                                                        $misUserNameVar=substr($misUserName, 0, 20)."..";
                                                                    }
                                                                    else
                                                                    {
                                                                        $misUserNameVar=$misUserName;
                                                                    }
                                                                ?>
                                                        ...
                                                        <?php for($mt_no=1;$mt_no<13;$mt_no++): ?>
                                                            ...
                                                            <td class="text-center" width="5.75%">
                                                                <?php
                                                                    $dueDateCount=0;
                                                                    if(isset($totalReturnsCountArr[$misUserId][$mth]))
                                                                    {
                                                                        $dueDateDataArr=$totalReturnsCountArr[$misUserId][$mth];
                                                    ...
                                                    <tr class="row-2">
                                                        ...
                                                        <?php for($mt_no=1;$mt_no<13;$mt_no++): ?>
                                                            ...
                                                            <td class="text-center" width="5.75%">
                                                                <?php
                                                                    $dueDateCount=0;
                                                                    if(isset($filedReturnsCountArr[$misUserId][$mth]))
                                                                    {
                                                                        $dueDateDataArr=$filedReturnsCountArr[$misUserId][$mth];
                                                        ...
                                                        <?php for($mt_no=1;$mt_no<13;$mt_no++): ?>
                                                            ...
                                                            <td class="text-center" width="5.75%">
                                                                <?php
                                                                    ...
                                                                    if(isset($totalReturnsCountArr[$misUserId][$mth]))
                                                                    {
                                                                        $totalDueDateDataArr=$totalReturnsCountArr[$misUserId][$mth];
                                                                    ...
                                                                    if(isset($filedReturnsCountArr[$misUserId][$mth]))
                                                                    {
                                                                        $filedDueDateDataArr=$filedReturnsCountArr[$misUserId][$mth];
