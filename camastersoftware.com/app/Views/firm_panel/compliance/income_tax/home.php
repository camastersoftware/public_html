                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-12 text-justify-center">
                            <a href="<?php echo base_url('tds_inc_menus'); ?>"> 
                                <div class="box box-inverse box-primary box-card-home box-card-clr p_clr">
                                    <div class="box-body box-p_new menu_box_new">
                                        <p class="font-weight-500 not_in_use">TDS - Income Tax</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3 col-12 text-justify-center">
                            <a href="<?php echo base_url('tcs_inc_menus'); ?>"> 
                                <div class="box box-inverse box-primary box-card-home box-card-clr p_clr">
                                    <div class="box-body box-p_new menu_box_new">
                                        <p class="font-weight-500 not_in_use">TCS - Income Tax</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3 col-12 text-justify-center">
                            <a href="<?php echo base_url('tds_gst_menus'); ?>"> 
                                <div class="box box-inverse box-primary box-card-home box-card-clr p_clr">
                                    <div class="box-body box-p_new menu_box_new">
                                        <p class="font-weight-500 not_in_use">TDS - GST</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3 col-12 text-justify-center">
                            <a href="<?php echo base_url('tcs_gst_menus'); ?>"> 
                                <div class="box box-inverse box-primary box-card-home box-card-clr p_clr">
                                    <div class="box-body box-p_new menu_box_new">
                                        <p class="font-weight-500 not_in_use">TCS - GST</p>
                                    </div>
                                </div>
                            </a>
                        </div>
