...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('body').on('submit', '.scrutiny_form', function(e){
            ...
            var postingUrl = base_url+'/income_tax/scrutiny_case/'+workId;
            // var postingUrl = base_url+'/admin/scrutiny';
            var refreshUrl = base_url+'/scrutiny';
        ...
        $('.add_hearing').on('click', function(e){
            ...
            var postingUrl = base_url+'/add_hearing';
            var refreshUrl = base_url+'/income_tax/scrutiny_case/'+workId;
        ...
        $('.delHearing').on('click', function(e){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url : base_url+'/delete_hearing_date',
                        type : 'POST',
                        data : {
