                                ...
                                <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                    <thead>
                                        <tr class="row-1">
                                            ...
                                            <th class="column-8">Additional</th>
                                            <th class="column-8">Whether</th>
                                            <th class="column-8">Decision</th>
                                            <th class="column-8" colspan="2">Payment Details</th>
                                        ...
                                        <tr class="row-1">
                                            ...
                                            <th class="column-4">Demand</th>
                                            <th class="column-11">Payable</th>
                                        ...
                                        <?php if(!empty($workDataArr)): ?>
                                            <?php foreach($workDataArr AS $e_inc_row): ?>
                                                ...
                                                <?php
                                                    ...
                                                    $demandAmtDate2=$e_inc_row['demandAmtDate2'];
                                                    $demandAmtDate3=$e_inc_row['demandAmtDate3'];
                                                    $demandAmtDate4=$e_inc_row['demandAmtDate4'];
                                                    
                                                    if(check_valid_date($demandAmtDate2)){
                                                        $demandPaidDate=date('d-m-Y', strtotime($demandAmtDate2));
                                                        if(check_valid_date($demandAmtDate3)){
                                                            $demandPaidDate=date('d-m-Y', strtotime($demandAmtDate3));
                                                            if(check_valid_date($demandAmtDate4)){
                                                                $demandPaidDate=date('d-m-Y', strtotime($demandAmtDate4));
                                                            }
                                                        }
                                                    }
                                                ...
                                                <tr class="row-1">
                                                    ...
                                                    <td class="column-9 text-center">
                                                        <?php
                                                            if(!empty($e_inc_row['whetherPayable']))
                                                            {
                                                                if($e_inc_row['whetherPayable']==1)
                                                                    echo "Yes";
                                                                elseif($e_inc_row['whetherPayable']==2)
                                                                    echo "No";
                                                                else
                                                                    echo "-";
                                                            }
                                                    ...
                                                    <td class="column-9 text-center">
                                                        <?php
                                                            if(!empty($e_inc_row['whetherPayable']))
                                                            {
                                                                ...
                                                                elseif($e_inc_row['whetherPayable']==2)
                                                                {
                                                                    if($e_inc_row['demandDecision']==1)
                                                                    {
                                                                        echo "Rectification";
                                                                    }
                                                                    elseif($e_inc_row['demandDecision']==2)
                                                                    {
                                                                        echo "Appeal";
                                                                    }
                                                                    else
                                                    ...
                                                    <td class="column-9">
                                                       <?php if(!empty($e_inc_row['totalDemandPaidAmt'])): ?>
                                                            <div class="text-right">
                                                                <?= amount_format($e_inc_row['totalDemandPaidAmt']); ?>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="text-center">-</div>
                                                        <?php endif; ?>
                                                    ...
                                                    <td class="column-9 text-center">
                                                        <?= (!empty($demandPaidDate)) ? $demandPaidDate : "-"; ?>
                                                    </td>
                                                    <td class="column-9">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" style="will-change: transform;">
                                                                <a class="dropdown-item" href="<?= base_url('demand-details/'.$e_inc_row['workId']); ?>">Demand Details</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
