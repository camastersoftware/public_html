                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url('it-statements/'.$ddfId); ?>">
                            ...
                            &nbsp;&nbsp;
                            <a href="<?= base_url('inc-tax-statements-ddf'); ?>">
                                                                ...
                                                                <td class="column-3 <?= $rowColor; ?>" width="15%" nowrap>
                                                                    ...
                                                                    <div class="tooltip-div">
                                                                        ...
                                                                        <span class='tooltipElem tooltipClr'>
                                                                			...
                                                                			<a href="<?= base_url('income_tax/work_form/'.$e_inc_row['workId']); ?>">
                                                                                <button type="button" class="waves-effect waves-light btn btn-sm btn-success">
...
<div id="Modalfilter-intax" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?= base_url('search-it-statements'); ?>" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?= base_url('reset-it-statements?ftr_type=2&ddfId='.$ddfId); ?>">
