                                                ...
                                                <?php if(!empty($workDataArr)): ?>
                                                    <?php foreach($workDataArr AS $e_inc_row): ?>
                                                        ...
                                                        <tr class="row-1">
                                                            ...
                                                            <td class="column-4 text-center">
                                                                <?php
                                                                    if(!empty($e_inc_row['ddfShortName']))
                                                                        echo $e_inc_row['ddfShortName'];
                                                                    else
                                                                        echo "-";
                                                                ?>
                                                            </td>
                                                            ...
                                                            <td class="column-9 text-center">
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu" style="will-change: transform;">
                                                                        <a class="dropdown-item" href="<?php echo base_url('income_tax/work_form/'.$e_inc_row['workId']); ?>">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
