                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3 col-12 text-justify-center">
                            <a href="<?php echo base_url('income_tax/appeals_scrutiny/1'); ?>">
                        ...
                        <div class="col-md-3 col-12 text-justify-center">
                            <a href="<?php echo base_url('income_tax/appeals_scrutiny/2'); ?>"> 
                                <div class="box box-inverse box-primary box-card-home box-card-clr p_clr card_box_shape">
                                    <div class="box-body box-p_new menu_box_new">
                        ...
                        <div class="col-md-3 col-12 text-justify-center">
                            <a href="<?php echo base_url('income_tax/appeals_scrutiny/3'); ?>"> 
                                <div class="box box-inverse box-primary box-card-home box-card-clr p_clr card_box_shape">
                                    <div class="box-body box-p_new menu_box_new">
                        ...
                        <div class="col-md-3 col-12 text-justify-center">
                            <a href="<?php echo base_url('income_tax/appeals_scrutiny/4'); ?>"> 
                                <div class="box box-inverse box-primary box-card-home box-card-clr p_clr card_box_shape">
                                    <div class="box-body box-p_new menu_box_new">
