                                                                                    ...
                                                                                    <?php if(!empty($mthDDFDueDateForClientArray)): ?>
                                                                                        <?php foreach($mthDDFDueDateForClientArray AS $e_inc_row): ?>
                                                                                            ...
                                                                                            <tr class="row-1">
                                                                                                ...
                                                                                                <td class="column-9">
                                                                                                    <?php 
                                                                                                        if(!empty($e_inc_row['totalIncome']))
                                                                                                            echo $e_inc_row['totalIncome'];
                                                                                                        else
                                                                                                            echo "-"; 
                                                                                                    ?>
                                                                                                </td>
                                                                                                <td class="column-9">
                                                                                                    <?php 
                                                                                                        if(!empty($e_inc_row['refundDueVal']))
                                                                                                            echo $e_inc_row['refundDueVal'];
                                                                                                        else
                                                                                                            echo "-"; 
                                                                                                    ?>
                                                                                                </td>
                                                                                                <td class="column-9">
                                                                                                    <?php 
                                                                                                        if(!empty($e_inc_row['selfAssessmentTax']))
                                                                                                            echo $e_inc_row['selfAssessmentTax'];
                                                                                                        else
                                                                                                            echo "-"; 
                                                                                                    ?>
                                                                                                </td>
                                                                                                <td class="column-9">
                                                                                                    <?php 
                                                                                                        if(!empty($e_inc_row['intiTotalIncome']))
                                                                                                            echo $e_inc_row['intiTotalIncome'];
                                                                                                        else
                                                                                                            echo "-"; 
                                                                                                    ?>
                                                                                                </td>
                                                                                                <td class="column-9">
                                                                                                    <?php 
                                                                                                        if(!empty($e_inc_row['intiRefundApproved']))
                                                                                                            echo $e_inc_row['intiRefundApproved'];
                                                                                                        else
                                                                                                            echo "-"; 
                                                                                                    ?>
                                                                                                </td>
                                                                                                <td class="column-9">
                                                                                                    <?php 
                                                                                                        if(!empty($e_inc_row['intiAddtnlTax']))
                                                                                                            echo $e_inc_row['intiAddtnlTax'];
                                                                                                        else
                                                                                                            echo "-"; 
                                                                                                    ?>
                                                                                                </td>
