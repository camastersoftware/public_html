        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h4 class="box-title">Income Tax-Appeals-Scrutiny Level - <?= $levelNo; ?></h4>
                    <a href="<?php echo base_url('appeals'); ?>"><button type="button" class="waves-effect waves-light btn btn-dark float-right" style="">Back</button></a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <!-- Tab panes -->
                                    ...
                                    <?php if(!empty($workDataArr)): ?>
                                        <?php foreach($workDataArr AS $e_row): ?>
                                            <tr class="row-1">
                                                ...
                                                <td class="column-2">
                                                    <a href="<?php echo base_url('income_tax/appeals_scrutiny_case/'.$e_row['leveId'].'/'.$e_row['workId']); ?>">
                                                        <?php //echo $e_row['clientName']; ?>
