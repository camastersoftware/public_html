                                                                ...
                                                                <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                                                    <thead>
                                                                        ...
                                                                        <tr class="row-1">
                                                                            ...
                                                                            <th class="column-6">Refund<br>Due</th>
                                                                            <th class="column-7">SA Tax<br>Paid</th>
                                                                            <th class="column-5">Total<br>Income</th>
                                                                            <th class="column-6">Refund<br>Apprvd</th>
                                                                                            ...
                                                                                            <?php if($e_inc_row['isScrutiny']==0): ?>
                                                                                                <div class="btn-group">
                                                                                                    ...
                                                                                                    <div class="dropdown-menu" style="will-change: transform;">
                                                                                                        <a class="dropdown-item" href="javascript:void(0);" class="scrutinyBtn" data-workid="<?php echo $e_inc_row['workId']; ?>" data-target="#Modalscrutiny">
