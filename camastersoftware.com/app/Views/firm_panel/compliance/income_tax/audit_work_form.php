                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12" id="doc_date">
                                                                <?php
                                                                    $docRecvdDate=(check_valid_date($workArr['docRecvdDate'])) ? date("Y-m-d", strtotime($workArr['docRecvdDate'])) : "";
                                                                ?>
                                                                <div class="form-group row">
                                                                    <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <?php $signature_date=(check_valid_date($workArr['signature_date'])) ? date("Y-m-d", strtotime($workArr['signature_date'])) : ""; ?>
                                                                <div class="form-group row">
                                                                    <div class="col-md-4">
                                                                        <label for="signature_date">Date Of Signature :</label>
                                                                    </div>
                                                                    <div class="col-md-8">
                                                                        <input type="date" class="form-control" name="signature_date" id="signature_date" value="<?= $signature_date; ?>"> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <?php $udinDate=(check_valid_date($workArr['udinDate'])) ? date("Y-m-d", strtotime($workArr['udinDate'])) : ""; ?>
                                                                <div class="form-group row">
                                                                    <div class="col-md-4">
                                                                        <label for="udinDate">UDIN Date :</label>
                                                                    </div>
                                                                    <div class="col-md-8">
                                                                        <input type="date" class="form-control" name="udinDate" id="udinDate" value="<?= $udinDate; ?>"> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <?php $auditCompletionDate=(check_valid_date($workArr['auditCompletionDate'])) ? date("Y-m-d", strtotime($workArr['auditCompletionDate'])) : ""; ?>
                                                                <div class="form-group row">
                                                                    <div class="col-md-4">
                                                                        <label for="auditCompletionDate">Audit Completion Date :</label>
                                                                    </div>
                                                                    <div class="col-md-8">
                                                                        <input type="date" class="form-control" name="auditCompletionDate" id="auditCompletionDate" value="<?= $auditCompletionDate; ?>"> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control" name="udinNo" id="udinNo" value="<?= $workArr['udinNo']; ?>"> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="3" class="form-control" name="remark" id="remark" placeholder="Enter Remark"><?= $workArr['remark']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="mt-0">
