                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url('inc_tax_audits'); ?>">
                                <button class="btn btn-sm btn-success" data-toggle="tooltip" data-original-title="Tax Audits Pending">
                                    Pending
                                </button>
                            </a>
                            &nbsp;&nbsp;
                                                                                ...
                                                                                <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                                                                    <thead>
                                                                                        <tr class="row-1">
                                                                                            ...
                                                                                            <th class="column-8" nowrap>DATE&nbsp;OF</th>
                                                                                            <th class="column-7">SET</th>
                                                                                            <th class="column-8" nowrap>DATE&nbsp;OF</th>
                                                                                            <th class="column-9">Billing</th>
                                                                                            <th class="column-11">Recipt</th>
                                                                                        </tr>
                                                                                        <tr class="row-1">
                                                                                            ...
                                                                                            <th class="column-9">UDIN</th>
                                                                                            <th class="column-12">Details</th>
                                                                                            <th class="column-13">Details</th>
                                                                                        </tr>
                                                                                    </thead>
                                                                                        ...
                                                                                        <?php if(isset($mthDDFDueDateForClientArr[$a][$k_ddf][$k_due_date])): ?>
                                                                                            ...
                                                                                            <?php if(!empty($mthDDFDueDateForClientArray)): ?>
                                                                                                <?php foreach($mthDDFDueDateForClientArray AS $e_inc_row): ?>
                                                                                                    ...
                                                                                                    <?php 
                                                                                                        $auditCompletionDate="-";
                                                                                                        if(!empty($e_inc_row['auditCompletionDate']) && $e_inc_row['auditCompletionDate']!="0000-00-00" && $e_inc_row['auditCompletionDate']!="1970-01-01")
                                                                                                            $auditCompletionDate=date('d-m-Y', strtotime($e_inc_row['auditCompletionDate'])); 
                                                                                                    ?>
                                                                                                    ...
                                                                                                    <?php 
                                                                                                        $udinDate="-";
                                                                                                        if(!empty($e_inc_row['udinDate']) && $e_inc_row['udinDate']!="0000-00-00" && $e_inc_row['udinDate']!="1970-01-01")
                                                                                                            $udinDate=date('d-m-Y', strtotime($e_inc_row['udinDate'])); 
                                                                                                    ?>
                                                                                                    ...
                                                                                                    <?php
                                                                                                        ...
                                                                                                        if(!empty($workPriorityColor) && $signature_date=='-')
                                                                                                        {
                                                                                                    ...
                                                                                                    <tr class="row-1 tbl_row_clr">
                                                                                                        ...
                                                                                                        <td class="column-8 text-center <?php if($signature_date!='-'): ?>hasCompleted<?php endif; ?>" width="5%">
                                                                                                            <?php echo $e_inc_row['workDone']; ?>
                                                                                                        </td>
                                                                                                        <td class="column-9 text-center <?php if($signature_date!='-'): ?>hasCompleted<?php endif; ?>" width="10%"  nowrap>
                                                                                                            <?php echo $auditCompletionDate; ?>
                                                                                                        </td>
                                                                                                        <td class="column-10 text-center <?php if($signature_date!='-'): ?>hasCompleted<?php endif; ?>" width="10%">
                                                                                                        ...
                                                                                                        <td class="column-10 text-center <?php if($udinDate!='-'): ?>hasCompleted<?php endif; ?>" width="7%" nowrap>
                                                                                                            <?php echo $udinDate; ?>
                                                                                                        </td>
        ...
        <div class="modal-content">
            <form action="" method="POST" >
                                    ...
                                    <select class="form-control select2" name="ftr_junior" id="ftr_junior" style="width:100%;">
                                        ...
                                        <?php if(!empty($getUserList)): ?>
                                            <?php foreach($getUserList AS $e_usr_val): ?>
                                                <option value="<?php echo $e_usr_val['userId']; ?>" <?php echo $ftr_junior==$e_usr_val['userId'] ? "selected":""; ?>><?php echo $e_usr_val['userFullName']; ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <select class="form-control" name="ftr_e_verify" id="ftr_e_verify">
                                        ...
                                        <option value="1" <?php echo $ftr_e_verify==1 ? "selected":""; ?>>Done</option>
                                        <option value="2" <?php echo $ftr_e_verify==2 ? "selected":""; ?>>Pending</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <select class="form-control" name="ftr_set_by" id="ftr_set_by">
                                        <option value="">Select</option>
                                        <option value="1" <?php echo $ftr_set_by==1 ? "selected":""; ?>>Done</option>
                                        <option value="2" <?php echo $ftr_set_by==2 ? "selected":""; ?>>Pending</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <select class="form-control" name="ftr_billing" id="ftr_billing">
                                        <option value="">Select</option>
                                        <option value="1" <?php echo $ftr_billing==1 ? "selected":""; ?>>Done</option>
                                        <option value="2" <?php echo $ftr_billing==2 ? "selected":""; ?>>Pending</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <select class="form-control" name="ftr_receipt" id="ftr_receipt">
                                        <option value="">Select</option>
                                        <option value="1" <?php echo $ftr_receipt==1 ? "selected":""; ?>>Done</option>
                                        <option value="2" <?php echo $ftr_receipt==2 ? "selected":""; ?>>Pending</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?php echo base_url('inc_tax_audits_filed'); ?>">
                        <button type="button" class="btn btn-warning text-left" >Reset</button>
                    </a>
                    <input type="hidden" name="selected_mth_tab" id="selected_mth_tab" value="<?= $selected_mth_tab; ?>" >
