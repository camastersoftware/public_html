                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url('tds-tcs-returns/'.$ddfId); ?>">
                            ...
                            &nbsp;&nbsp;
                            <a href="<?= base_url('tds-tcs-returns-ddf'); ?>">
...
<div id="Modalfilter-intax" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?= base_url('search-tds-tcs-returns'); ?>" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?= base_url('reset-tds-tcs-returns?ftr_type=2&ddfId='.$ddfId); ?>">
