        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <div class="row">
                        <div class="col-6">
                            <h4 class="box-title font-weight-bold"><?= $due_date_for; ?> - Filed</h4>
                        </div>
                        <div class="col-6 text-right">
                            <a href="<?= base_url('tds-tcs-certificates/'.$ddfId); ?>">
                            ...
                            &nbsp;&nbsp;
                            <a href="<?= base_url('tds-tcs-certificates-ddf'); ?>">
                                                                ...
                                                                <td class="column-3 <?= $rowColor; ?>" width="15%" nowrap>
                                                                    ...
                                                                    <div class="tooltip-div">
                                                                        ...
                                                                        <span class='tooltipElem tooltipClr'>
                                                                			...
                                                                			<a href="<?= base_url('tds-tcs-work-form/'.$e_inc_row['workId']); ?>">
                                                                                <button type="button" class="waves-effect waves-light btn btn-sm btn-success">
...
<div id="Modalfilter-intax" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?= base_url('search-tds-tcs-certificates'); ?>" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?= base_url('reset-tds-tcs-certificates?ftr_type=2&ddfId='.$ddfId); ?>">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#ftr_clientgrp').on('change', function(){
            ...
            var client_arr = '<?= json_encode($client_arr); ?>';
            var selected=null;
            var selClient="<?= $ftr_client; ?>";
