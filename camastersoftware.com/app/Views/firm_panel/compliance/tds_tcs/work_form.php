        ...
        <div class="col-12">
            ...
            <div class="box box-default">
                ...
                <div class="box-body card_bg_format">
                    <form action="<?= base_url('tds-tcs-work-form/'.$workId); ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                                ...
                                <div class="form-group row form_bg_format">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-lg-3 text-center">
                                                <span class="font-weight-bold">TAN :&nbsp;</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    <div class="col-md-4">
                                                                        <label for="seniorId">Senior Staff :</label>
                                                                    </div>
                                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="<?php if(!empty($ackUploadFile)): ?>col-md-7<?php else: ?>col-md-8<?php endif; ?>">
                                                                    ...
                                                                    <?php if(!empty($ackUploadFile)): ?>
                                                                        <div class="col-md-1">
                                                                            ...
                                                                            <a href="<?= $ackUploadFilePath; ?>" target="_blank">
                                                                                <button type="button" class="waves-effect waves-light btn btn-warning btn-sm" >View</button>
                                                                            </a>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="tdsTcsAmtPaid">Amount Paid :</label>
                                                                    <input type="text" class="form-control" name="tdsTcsAmtPaid" id="tdsTcsAmtPaid" placeholder="Enter Amount Paid" value="<?php echo $workArr['tdsTcsAmtPaid']; ?>" onkeypress="validateNum(event)">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="taxDeductedCollected">Tax Deducted/Collected :</label>
                                                                    <input type="text" class="form-control" name="taxDeductedCollected" id="taxDeductedCollected" placeholder="Enter Tax Deducted/Collected" value="<?php echo $workArr['taxDeductedCollected']; ?>" onkeypress="validateNum(event)">
                                                                </div>
                                                            </div>	
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="state due-month">
                                                    <h4 class="text-white font-weight-bold m-0">TDS-TCS Scrutiny</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group row mb-0">
                                                            <div class="col-md-6">
                                                                <label for="isScrutiny">Whether selected for TDS-TCS Scrutiny :</label>
                                                            </div>
                                                            <div class="col-md-6">
