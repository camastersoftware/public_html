                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url('inc_tax_audits_filed'); ?>">
                                <button class="btn btn-sm btn-success" data-toggle="tooltip" data-original-title="Tax Audits Filed">
                                    Filed
                                </button>
                            </a>
                            &nbsp;&nbsp;
        ...
        <div class="modal-content">
            <form action="" method="POST" >
                ...
                <div class="modal-footer text-right" style="width: 100%;">
                    ...
                    <a href="<?php echo base_url('inc_tax_audits'); ?>">
