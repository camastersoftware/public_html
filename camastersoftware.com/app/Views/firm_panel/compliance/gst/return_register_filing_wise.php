                ...
                <div class="box-header with-border">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="<?= base_url('gst-return-register'); ?>">
                                <button class="btn btn-sm btn-success" data-toggle="tooltip" data-original-title="Due Date For Wise Return Registers">
                                    Due Date For Wise
                                </button>
                            </a>
                            &nbsp;&nbsp;
                            <a href="<?php echo base_url('gst-menus'); ?>">
                                            ...
                                            <?php foreach($workDataArr AS $e_inc_row): ?>
                                                ...
                                                <tr class="row-1">
                                                    ...
                                                    <td class="column-2">
                                                        ...
                                                        ?>
                                                        <a href="<?= base_url('gst-work-form/'.$e_inc_row['workId']); ?>" data-toggle="tooltip" data-original-title="<?php echo $clientNameVar; ?>">
                                                            <?php 
