                                    ...
                                    <div class="row">
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label>Per day salary<small class="text-danger">*</small></label>
                                                <input type="text" class="form-control" name="DINNo" id="DINNo" placeholder="Enter Per day salary" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
