                            ...
                            <div class="col-12">
                                <div class="tab-pane fade show active" id="apr_tab" role="tabpanel" aria-labelledby="apr-tab">
                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable-act no-footer">
                                        <thead>
                                            <tr class="row-1">
                                                <th class="column-1" colspan="5"></th>
                                                <th class="column-2" colspan="3">On Traces Site</th>
                                                <th class="column-3" colspan="2">On Income Tax Web Portal</th>
                                            </tr>
                                            <tr class="row-1">
                                                ...
                                                <th class="column-5">PAN</th>
                                                <th class="column-6">TAN</th>
                                                <th class="column-7">User Id</th>
                                                <th class="column-8">Password</th>
                                                <th class="column-9">User Id</th>
                                                <th class="column-10">Password</th>
                                            </tr>
                                        </thead>
                        ...
                        <div class="row">
                        	<div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control" name="NameofClient" id="NameofClient" required>
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>PAN No<small class="text-danger">*</small></label>
                                    <input type="text" class="form-control" name="pan_no" id="pan_no" placeholder="Enter PAN No" required>
                                </div>
                            </div>
                            <div class="form-group">
                                 <label>On Traces site :</label>
                             </div>
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>TAN<small class="text-danger">*</small></label>
                                    <input type="text" class="form-control" name="TAN" id="TAN" placeholder="Enter TAN" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>On Income Tax Web Portal :</label>
                            </div>    
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>User Id<small class="text-danger">*</small></label>
