                        ...
                        <section>
                            ...
                            <div class="row sel_act_due_date">
                                ...
                                <?php if(!empty($workMthArr)): ?>
                                    <?php $mthLastKey = array_key_last($workMthArr); ?>
                                                    ...
                                                    <tbody class="row-hover">
                                                        ...
                                                        <?php if(!empty($wkListArr)): ?>
                                                                                                            ...
                                                                                                            <?php if(!empty($staffCostArray)): ?>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td nowrap width="20%" class="text-right">
                                                                                                                        ...
                                                                                                                        ?>
                                                                                                                        <?php echo $tsTotalHoursTotalVal; ?>
                                                                                                                    </td>
                                                                                                                    <td nowrap width="20%" class="text-right">
                                                                                                                        <?php echo amount_format($tsTotalCostTotal); ?>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            <?php else: ?>
                                                                                                                <tr>
                                                            ...
                                                            <?php if($k_row == $lastKey): ?>
                                                                <tr class="row-3">
                                                                    ...
                                                                    <td class="column-4 text-right" style="width: 5% !important;" nowrap>
                                                                        <?= amount_format($totalWorkTotalCost); ?>
                                                                    </td>
                                                                    <td class="column-4 text-right" style="width: 5% !important;" nowrap>
                                                                        <?= amount_format($totalBillAmt); ?>
                                                                    </td>
                                                                    <td class="column-4 text-right" style="width: 5% !important;" nowrap>
                                                                        <?= amount_format($totalReceiptAmt); ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endif; ?>
                                                            <?php endforeach; ?>
                                                        ...
                                                        <?php if($k_mth_id == $mthLastKey): ?>
                                                            <tr class="row-3">
                                                                ...
                                                                <td class="column-4 text-right" style="width: 5% !important;" nowrap>
                                                                    <?= amount_format($grandTotalWorkTotalCost); ?>
                                                                </td>
                                                                <td class="column-4 text-right" style="width: 5% !important;" nowrap>
                                                                    <?= amount_format($grandTotalBillAmt); ?>
                                                                </td>
                                                                <td class="column-4 text-right" style="width: 5% !important;" nowrap>
                                                                    <?= amount_format($grandTotalReceiptAmt); ?>
                                                                </td>
                                                            </tr>
                                                        <?php endif; ?>
                                                    </tbody>
