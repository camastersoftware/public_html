                                                    ...
                                                    <?php if(!empty($wkListArr)): ?>
                                                        <?php foreach($wkListArr AS $k_row=>$e_row): ?>
                                                            ...
                                                            <tr class="row-3 row_<?= $uniQId; ?> <?php if($eFillingDate!="-"): ?>hasCompleted<?php endif; ?>" >
                                                                                                        ...
                                                                                                        <?php if(isset($staffCostArr[$e_row['workId']])): ?>
                                                                                                            ...
                                                                                                            <?php if(!empty($staffCostArray)): ?>
                                                                                                                ...
                                                                                                                <?php foreach($staffCostArray AS $e_staff): ?>
                                                                                                                    <?php 
                                                                                                                        $tsWorkedHours = getHoursAndMinutesFormat($e_staff['tsTotalHours']); 
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td nowrap width="20%" class="text-center">
                                                                ...
                                                                <td class="column-4 text-center" style="width: 5% !important;" nowrap>
                                                                    <?php 
                                                                        if(!empty($e_row['workTotalCost']))
                                                                            echo amount_format($e_row['workTotalCost']); 
                                                                        else
                                                                            echo 0; 
                                                                    ?>
                                                                </td>
                                                                <td class="column-4 text-center" style="width: 5% !important;" nowrap>
                                                                    <?php 
                                                                        if(!empty($e_row['billAmt']))
                                                                            echo amount_format($e_row['billAmt']); 
                                                                        else
                                                                            echo 0; 
                                                                    ?>
                                                                </td>
                                                                <td class="column-4 text-center" style="width: 5% !important;" nowrap>
                                                                    <?php 
                                                                        if(!empty($e_row['receiptAmt']))
                                                                            echo amount_format($e_row['receiptAmt']); 
                                                                        else
                                                                            echo 0; 
                                                                    ?>
                                                                </td>
