                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <?php if(!empty($img_file)): ?>
                                                                <div class="col-md-4 col-lg-4">
                                                                    <?php $uploadFilePath = base_url("uploads/admin/query_files/".$img_file); ?>
                                                                    <div class="mt-30">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group text-right">
                                                            ...
                                                            <input type="hidden" name="errType" id="errType" value="<?= $errType; ?>"> 
	    ...
	    $('body').on('click', '.deleteUploadedFile', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url : base_url+'/superadmin/delete-error-report-img-file',
                        type : 'POST',
                        data : {
                            'errId':errId
                        },
