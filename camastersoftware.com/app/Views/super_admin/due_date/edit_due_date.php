                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" name="due_date" id="due_date" value="<?= (check_valid_date($dueDatesArr['due_date'])) ? date("Y-m-d", strtotime($dueDatesArr['due_date'])) : ""; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="due_notes" id="due_notes" class="form-control textarea_input hide" rows="20" placeholder="Enter Notes"><?= $due_notes_data; ?></textarea>
                                                                    <!--<textarea name="due_notes" id="due_notes" class="form-control textarea" rows="20" placeholder="Enter Notes" ><?//= $due_notes_data; ?></textarea>-->
                                                                </div>
                                                            </div>
