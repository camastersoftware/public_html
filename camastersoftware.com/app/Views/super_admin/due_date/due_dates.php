                ...
                <div class="box">
                   <div class="box-header with-border flexbox">
                        ...
                        <div class="text-right flex-grow">
                            <a href="<?php echo base_url('superadmin/add_due_date'); ?>" >
                                <button class="btn btn-sm btn-submit">Add Due Date</button>
                            </a>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <!--<div class="row" id="filterLabels">-->
                        <!--</div>-->
                        <div class="row mb-10">
                            <div class="col-md-6">
                                        ...
                                        <?php if($mainCond): ?>
                                            <?php foreach($dueDatesArr AS $k_row=>$e_row): ?>
                                                ...
                                                <tr class="row-3 <?php if($e_row['is_extended']==1): ?>ext_date_row<?php endif; ?>" style="background-color:<?php if($e_row['is_extended']==2): ?>#96c7f242<?php else: ?><?php echo EXT_DUE_DATE_STYLE; ?><?php endif; ?>;">
                                                    <td class="column-1" nowrap><?php echo date('d-m-Y', strtotime($e_row['extended_date'])); ?></td>
                                                    ...
                                                    <td class="column-2">
                                                        <?php 
                                                            ...
                                                            // echo $ddForm."-".$e_row['act_option_name1']; 
                                                    ...
                                                    <?php endif; ?>
                                                    <td class="column-4 text-center" style="width: 130px;">
                                                    <?php
                                                    ...
                                                    <td class="column-9 text-center" nowrap>
                                                        <?php 
                                                            if($e_row['periodicity']=="1")
                                                            {
                                                                if(check_valid_date($e_row["daily_date"]))
                                                        ...
                                                        <div class="btn-group mb-5">
                                                            ...
                                                            <div class="dropdown-menu" style="will-change: transform;">
                                                                ...
                                                                <?php if($e_row['is_extended']==2): ?>
                                                                    ...
                                                                    <?php endif; ?>
                                                                <?php endif; ?>
                                                                <a class="dropdown-item" href="<?php echo base_url('superadmin/duedate/edit_due_date/'.$e_row['due_date_id']); ?>">Edit</a>
                                                                <a class="dropdown-item" href="<?php echo base_url('superadmin/duedate/extend_due_date/'.$e_row['due_date_id']); ?>">Extend</a>
                                                                <?php if($e_row['isFirst']==2): ?>
                                                                    <a class="dropdown-item delExtDueDate" href="javascript:void(0);" data-id="<?php echo $e_row['due_date_id']; ?>" id="<?php echo $e_row['ext_due_date_master_id']; ?>">Delete</a>
                                                                <?php else: ?>
                                                                    <a class="dropdown-item delDueDate" href="javascript:void(0);" id="<?php echo $e_row['due_date_id']; ?>">Delete</a>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
...
<div id="Modalfilter-intax" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?= base_url('superadmin/due_dates')?>" method="POST" >
                <div class="modal-header">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#due_act_sel').on('change', function(){
            ...
            window.location.href=base_url+"/superadmin/due_dates?due_act_sel="+due_act_sel;
        });
...
<script>
    $(document).ready(function(){
        $('.delDueDate').on('click', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/superadmin/delete_due_date';
                    $.post(postingUrl, 
                    {
                        due_date_id: due_date_id
                    },
                    function(data, status){
                        window.location.href=base_url+"/superadmin/due_dates";
                    });
        ...
        $('.delExtDueDate').on('click', function () {

            var base_url = "<?php echo base_url(); ?>";
            var due_date_id = $(this).attr('data-id');
            var ext_due_date_master_id = $(this).attr('id');
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var postingUrl = base_url+'/superadmin/delete_ext_due_date';
                    $.post(postingUrl, 
                    {
                        due_date_id: due_date_id,
