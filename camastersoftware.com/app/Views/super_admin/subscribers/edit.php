        ...
        <div class="col-12">
            ...
            <div class="box box-default mt-40">
                <div class="box-header with-border flexbox">
                    <h4 class="box-title font-weight-bold">Subscriber Registration Form</h4>
                    <div class="text-right flex-grow">
                        <a href="<?php echo base_url('superadmin/subscribers'); ?>" >
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group <?php if(!empty($caFirmNameErr)): ?>has-error<?php endif; ?>">
                                        ...
                                        <input type="text" class="form-control" name="caFirmName" id="caFirmName" placeholder="Enter Firm Name" value="<?php echo set_value('caFirmName', $firmData['caFirmName']); ?>" onkeypress='validateChar(event)' > 
