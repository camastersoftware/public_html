...
.tablepress tbody tr:first-child td {
    ...
    <section class="content mt-35">
        <div class="row">
                        ...
                        <div class="box-body">
                            <div class="row"> 
                                <div class="col-xl-12 col-lg-12 col-12 text-justify-center table-responsive">
                                    <table id="tablepress-2" class="tablepress tablepress-id-2 custom-table dataTable no-footer mt-0" style="margin-top: 0px !important;">
                                    	<thead>
                                    		<tr class="row-1">
                                    	...
                                    	<tbody class="row-hover">	
                                            <?php if(!empty($dueDatesArr)): ?>
                                                <?php foreach($dueDatesArr AS $k_row=>$e_row): ?>
                                                    <tr class="row-3" style="background:#96c7f242 !important;">
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p>
                                                                                <?php 
                                                                                    if(!empty($e_row['due_notes']))
                                                                                        echo $e_row['due_notes']; 
                                                                                    else
                                                                                        echo "N/A";
                                                                                ?>
                                                                            </p>
           ...
           <!--                         <a href="<?php echo base_url('superadmin/master_data'); ?>">Master Data</a>-->
           <!--                     </div>-->
